<div class="card" style="width: 100%; display:none;" id="VerkaufsstatistikenPH3">
        ...
        <div class="d-flex justify-content-between p-1">
            ...
            <button id="selectedDataVerkauf14" style="width:24.9%; display:none;" class="btn btn-dark">PDF-Bericht</button>
            <button id="selectedDataVerkauf15" style="width:24.9%; display:none;" class="btn btn-dark">Selektiv/Alle PDF-Bericht</button>
            ...
            <button onclick="reshowDatesToSelect('day')" id="selectedDataVerkauf41" style="width:24.9%; display:none;" class="btn btn-outline-dark">
                <strong>Tag ändern</strong>
            </button>
            <button onclick="reshowDatesToSelect('week')" id="selectedDataVerkauf42" style="width:24.9%; display:none;" class="btn btn-outline-dark">
                <strong>Woche wechseln</strong>
            </button>
            <button onclick="reshowDatesToSelect('month')" id="selectedDataVerkauf43" style="width:24.9%; display:none;" class="btn btn-outline-dark">
                <strong>Monat ändern</strong>
            </button>
            <button onclick="reshowDatesToSelect('year')" id="selectedDataVerkauf44" style="width:24.9%; display:none;" class="btn btn-outline-dark">
