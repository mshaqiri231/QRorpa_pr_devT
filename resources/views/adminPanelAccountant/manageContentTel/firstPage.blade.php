...
<div  class="d-flex flex-wrap justify-content-between pl-2 pr-2">
    <a href="{{route('admWoMng.AccountPanelProduktetOrder')}}" style="width:100%;  background-color:rgb(39,190,175); border-radius:15px; color:white; font-size:17px;" class="btn p-2">
...
<div id="showMenuTel">
    @include('adminPanelAccountant.manageContentTel.showMenu')
</div>

<div id="modalsDivTel">
 @include('adminPanelAccountant.manageContentTel.addModals')
 @include('adminPanelAccountant.manageContentTel.editModals')
 @include('adminPanelAccountant.manageContentTel.addETModals')
</div>
