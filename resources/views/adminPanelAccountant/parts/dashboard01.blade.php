...
<div class="d-flex justify-content-between">
    @if (!isset($_GET['orSk']) || (isset($_GET['orSk']) && $_GET['orSk'] == 0))
        <button class="btn btn-dark mb-2" style="width:10%;"><strong>0-1000</strong></button>
    @else
        @if(isset($_GET['mo']) && isset($_GET['ye']))
        <?php $mo=$_GET['mo']; $ye=$_GET['ye']; ?>
        <button onclick="location.href = 'AccountantStatisticsDash1?orSk=0&mo={{$mo}}&ye={{$ye}}';" class="btn btn-outline-dark mb-2" style="width:10%;"><strong>0-1000</strong></button>
        @else
        <button onclick="location.href = 'AccountantStatisticsDash1?orSk=0';" class="btn btn-outline-dark mb-2" style="width:10%;"><strong>0-1000</strong></button>
        @endif
    @endif
    ...
    @foreach (range(1, 8) as $nrRend) 
        ...
        @if ($OrderAllCount > $rngSt && $OrderAllCount >= $rngEd)
            ...
            @else
                @if(isset($_GET['mo']) && isset($_GET['ye']))
                <?php $mo=$_GET['mo']; $ye=$_GET['ye']; ?>
                <button onclick="location.href = 'AccountantStatisticsDash1?orSk={{$rngSt}}&mo={{$mo}}&ye={{$ye}}';" class="btn btn-outline-dark shadow-none mb-2" style="width:10%;"><strong>{{$rngSt+1}}-{{$rngEd}}</strong></button>
                @else
                <button onclick="location.href = 'AccountantStatisticsDash1?orSk={{$rngSt}}';" class="btn btn-outline-dark shadow-none mb-2" style="width:10%;"><strong>{{$rngSt+1}}-{{$rngEd}}</strong></button>
                @endif
            @endif
        @elseif ($OrderAllCount > $rngSt)
            ...
            @else
                @if(isset($_GET['mo']) && isset($_GET['ye']))
                <?php $mo=$_GET['mo']; $ye=$_GET['ye']; ?>
                <button onclick="location.href = 'AccountantStatisticsDash1?orSk={{$rngSt}}&mo={{$mo}}&ye={{$ye}}';" class="btn btn-outline-dark shadow-none mb-2" style="width:10%;"><strong>{{$rngSt+1}}-{{$OrderAllCount}}</strong></button>
                @else
                <button onclick="location.href = 'AccountantStatisticsDash1?orSk={{$rngSt}}';" class="btn btn-outline-dark shadow-none mb-2" style="width:10%;"><strong>{{$rngSt+1}}-{{$OrderAllCount}}</strong></button>
                @endif
            @endif
        @else
