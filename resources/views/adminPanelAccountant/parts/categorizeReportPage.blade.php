...
<div class="p-3 pb-5">
    ...
    <div class="d-flex justify-content-between mt-2 mb-2">
        ...
        <h3 style="color:rgb(39,190,175); width:50%;">
            <strong> 
                <a href="{{route('admWoMng.AccountantStatistics')}}" class="pl-4 pr-4" style="width: 10%; color:rgb(39,190,175);"><strong><i class="fas fa-chevron-left"></i></strong></a> 
    ...
    <div class="p-2 d-flex flex-wrap justify-content-between" id="repCategories">
        @if ($pdfResPCats->count() > 0)
            ...
            <p style="width: 15%; font-size:1.25rem;" class="text-center">{{Produktet::where([['toRes',Auth::user()->sFor],['toReportCat',$oneRepCat->id]])->count()}}</p>
            ...
            <p style="width: 15%; font-size:1.25rem;" class="text-center">{{Produktet::where([['toRes',Auth::user()->sFor],['toReportCat',0]])->count()}}</p>
            <p style="width: 25%;"></p>
        @else
