...
?>
    ...
    <div class="card" style="width: 100%;" id="VerkaufsstatistikenPH1">
        ...
        <div class="d-flex flex-wrap flex-wrap justify-content-between p-1">
            @if ($exAcs->count() > 0 || 1 == 1)
                ...
                @elseif($theRes->resType == 7 || $theRes->resType == 9)
                    <button id="selectPH11" onclick="selectPH1('1')" style="width: 49.9%;" class="text-center btn btn-outline-dark"> <strong> {{__('adminP.restaurant')}} </strong> </button>
                    <button id="selectPH12" onclick="selectPH1('2')" style="width: 49.9%;" class="text-center btn btn-outline-dark"> <strong> {{__('adminP.takeaway')}} </strong> </button>
                    <button id="selectPH13" onclick="selectPH1('3')" style="width: 49.9%;" class="text-center btn btn-outline-dark"> <strong> {{__('adminP.delivery')}} </strong> </button>
                    <button id="selectPH14" onclick="selectPH1('4')" style="width: 49.9%;" class="text-center btn btn-outline-dark"> <strong> PDF-Bericht </strong> </button>
                @endif
                <button id="selectPH15" onclick="selectPH1('5')" style="width: 100%;" class="text-center btn btn-outline-dark"> <strong> Selektiv/Alle PDF-Bericht </strong> </button>
            @else
                @if($theRes->resType == 1 || $theRes->resType == 5)
                    <button id="selectPH11" onclick="selectPH1('1')" style="width: 49%;" class="text-center btn btn-outline-dark"> <strong> {{__('adminP.restaurant')}}</strong> </button>
                    <button id="selectPH14" onclick="selectPH1('4')" style="width: 49%;" class="text-center btn btn-outline-dark"> <strong> PDF-Bericht </strong> </button>
