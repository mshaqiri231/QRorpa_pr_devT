...
<?php
 ...
 ?>
<p style="color: rgb(39,190,175); font-size:30px; text-align:center; width:100%;"><strong>Ihr Tisch wurde reserviert!</strong></p>
<p style="width:100%;"></p>
<div style="width:100%; height:200px; text-align:center;">
    <img style="width:200px !important; height:200px !important; border-radius:50% !important;" width="200" height="200" border-radius="100" src="{{url('storage/ResProfilePic/'.$theRest->profilePic)}}" alt="">
</div>
<p style="width:100%;"></p>
<p style="width:100%; margin-bottom:2px; margin-top:35px; padding:0px;"><strong>Hallo {{ $clName }}</strong></p>
<p style="width:100%; margin:2px; padding:0px;"><strong>{{ $theRest->emri }} hat ihre Reservierung bestätigt.</strong></p>
...
<p style="width:100%; margin-bottom:2px; margin-top:35px; padding:0px;"><strong>Vielen Dank für Ihre Reservierung. Wir wünschen Ihnen einen angenehmen Aufenthalt.</strong></p>
...
<div style="width:100%; text-align:center;">
    ...
    <span style="margin-right: 10px; margin-left:10px;"><strong>|</strong></span>
