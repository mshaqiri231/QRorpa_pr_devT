<?php
    ...
    $totResBr = number_format(0, 2, '.', ' ');
    $totResMwst = number_format(0, 2, '.', ' ');
    $totResNe = number_format(0, 2, '.', ' ');
...
?>
    ...
    @if ($showTable)
                ...
                <tr>
                    <td colspan="6"><strong>Restaurant (Karte)</strong></td>
                </tr>
                        ...
                        @foreach (explode('---8---',$orOne->porosia) as $porOne)
                            <?php 
                                ...
                                if($theP != NULL){
                                    ...
                                    $totInCHF += number_format($porOne2D[4], 2, '.', ' ');
                                }
                            ?>
                        @endforeach
                        <?php
                ...
                @foreach ($prodGroups as $key) 
                    <?php
                        $theBrutoVal = number_format($grBruto[$key], 2, '.', ' ');
                        $percVal = number_format((($theBrutoVal / $totInCHF) * 100), 2, '.', ' ');
                        $grAnteil[$key] = $percVal;
                    ?>
                @endforeach
    ...
    @endif
        ...
        @if ($showTable)
            ...
            <tr>
                <td colspan="6"><strong>Restaurant (Online)</strong></td>
            </tr>
        ...
        @if ($showTable)
            ...
            <tr>
                <td colspan="6"><strong>Restaurant (Auf Rechnung)</strong></td>
            </tr>
