<?php
    ...
    $totTakBr = number_format(0, 2, '.', ' ');
    $totTakMwst = number_format(0, 2, '.', ' ');
    $totTakNe = number_format(0, 2, '.', ' ');
...
?>
    ...
    @if ($showTable)
                <tr>
                    <td colspan="6"><strong>Takeaway (Bar)</strong></td>
                </tr>
                ...
                @if ( $totDiscount > 0)
                    ...
                    <?php
                        ...
                        $totTakBr += number_format($brutoAfterD, 2, '.', ' ');
                        $totTakMwst += number_format($mwstAfterD, 2, '.', ' ');
                        $totTakNe += number_format($netoAfterD, 2, '.', ' ');
                    ?>
                    <tr class="heading">   
                ...
                @else
                    <?php
                        $totTakBr += number_format($sumBruto, 2, '.', ' ');
                        $totTakMwst += number_format($sumMwst, 2, '.', ' ');
                        $totTakNe += number_format($sumNeto, 2, '.', ' ');
                    ?>
                @endif
    @endif
    ...
    @if ($showTable)
                ...
                <tr>
                    <td colspan="6"><strong>Takeaway (Karte)</strong></td>
                </tr>
    ...
    @if ($showTable)
                ...
                <tr>
                    <td colspan="6"><strong>Takeaway (Online)</strong></td>
                </tr>
    ...
    <tr class="heading">
        <td colspan="2" style="text-align: left; background: #6e6e6e !important; color:white;">
            <strong> Summen für Takeaway </strong>
        </td>
        <td style="text-align: right; background: #6e6e6e !important; color:white;">
            <strong>CHF {{number_format($totTakBr, 2, '.', ' ')}}</strong>
        </td>
        <td style="text-align: right; background: #6e6e6e !important; color:white;">
            <strong>CHF {{number_format($totTakMwst, 2, '.', ' ')}}</strong>
        </td>
        <td style="text-align: right; background: #6e6e6e !important; color:white;">
            <strong>CHF {{number_format($totTakNe, 2, '.', ' ')}}</strong>
        </td>
        <td style="text-align: right; background: #6e6e6e !important; color:white;">
            <strong>{{number_format($totTakSasia, 0, '.', ' ')}} X</strong>
        </td>
    </tr>
    @endif