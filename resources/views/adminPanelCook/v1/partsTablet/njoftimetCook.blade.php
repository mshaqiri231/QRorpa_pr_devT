...
<script>
    ...
    function onReload () {
        $('#soundsAllCookTab').html('<audio id="soundsAllCookTablBeep" src="https://qrorpa.ch/storage/sound/cookPanelNoty.mp3" type="audio/mpeg" autoplay="true"></audio>');
        // $("#soundsAllCookTab").load(location.href+" #soundsAllCookDes>*","");
        var selAudio = $("#soundsAllCookTablBeep")[0];
        selAudio.play();
    }
