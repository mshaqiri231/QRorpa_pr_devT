...
<nav style="background-color: rgb(39,190,175);" class="navbar navbar-expand-lg d-flex justify-content-between">
    <a class="navbar-brand" href="#"><img src="storage/images/logo_QRorpa_wh.png" style="width:250px; height:auto;" alt=""></a>
    ...
    @if(Request::is('cookPanelIndexCookT') || Request::is('cookPanelIndexCookD'))
        ...
        @if(count($allActConfOrders) > 0)
            <a href="{{ route('cookPnl.cookPanelIndexCook') }}" style="width:300px; background-color:red; color:white; font-size:1.6rem;" class="btn btn-danger table-glow-adminAlert">
                <strong>Restaurant</strong>
            </a>
        @else
            <a href="{{ route('cookPnl.cookPanelIndexCook') }}" style="width:300px; background-color:white; color:rgb(39,190,175); font-size:1.6rem;" class="btn btn-default">
                <strong>Restaurant</strong>
            </a>
        @endif
    ...
    @if(cooksProductSelection::where([['workerId',Auth::user()->id],['contentType','Takeaway']])->first() != NULL && (Request::is('cookPanelIndexCook') || Request::is('cookPanelIndexCookD')))
        ...
        ?>
        @if(count($allActConfOrders) > 0)
            <a href="{{ route('cookPnl.cookPanelIndexCookT') }}" style="width:300px; background-color:red; color:white; font-size:1.6rem;" class="btn btn-danger table-glow-adminAlert">
                <strong>Takeaway</strong>
            </a>
        @else
            <a href="{{ route('cookPnl.cookPanelIndexCookT') }}" style="width:300px; background-color:white; color:rgb(39,190,175); font-size:1.6rem;" class="btn btn-default">
                <strong>Takeaway</strong>
            </a>
        @endif
    ...
    <a href="{{ route('cookPnl.cookPanelIndexCookD') }}" style="width:300px; background-color:white; color:rgb(39,190,175); font-size:1.6rem;" class="btn btn-default">
