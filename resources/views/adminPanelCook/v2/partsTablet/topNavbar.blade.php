...
<nav id="cookPanelNavBar" style="background-color: rgb(39,190,175);" class="navbar navbar-expand-lg d-flex justify-content-between">
    ...
    @if(Request::is('cookPanelIndexCookT') || Request::is('cookPanelIndexCookTNotConf') || Request::is('cookPanelIndexCookD'))
        ...
        <a href="{{ route('cookPnl.cookPanelIndexCook') }}" style="width:75px; background-color:red; color:white; font-size:1.6rem;" class="btn btn-danger table-glow-adminAlert">
            <strong>R</strong>
        </a>
        @else
        <a href="{{ route('cookPnl.cookPanelIndexCook') }}" style="width:75px; background-color:white; color:rgb(39,190,175); font-size:1.6rem;" class="btn btn-default">
            <strong>R</strong>
        </a>
        @endif
    @endif
    ...
    @if(cooksProductSelection::where([['workerId',Auth::user()->id],['contentType','Takeaway']])->first() != NULL && (Request::is('cookPanelIndexCook') || Request::is('cookPanelIndexCookNotConf') || Request::is('cookPanelIndexCookD')))
        ...
        <a href="{{ route('cookPnl.cookPanelIndexCookT') }}" style="width:75px; background-color:red; color:white; font-size:1.6rem;" class="btn btn-danger table-glow-adminAlert">
            <strong>T</strong>
        </a>
        @else
        <a href="{{ route('cookPnl.cookPanelIndexCookT') }}" style="width:75px; background-color:white; color:rgb(39,190,175); font-size:1.6rem;" class="btn btn-default">
            <strong>T</strong>
        </a>
        @endif
    @endif
    ...
    <a href="{{ route('cookPnl.cookPanelIndexCookD') }}" style="width:75px; background-color:white; color:rgb(39,190,175); font-size:1.6rem;" class="btn btn-default">
        <strong>D</strong>
    </a>
    @endif
