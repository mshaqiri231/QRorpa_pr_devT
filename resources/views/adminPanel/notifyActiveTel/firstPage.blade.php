...
<div class="pt-2 ">
    ...
    <div class="d-flex justify-content-between flex-wrap pr-2 pl-2 pb-4" style="background-color: rgb(39,190,175);">
        <div style="width: 100%; border: 1px solid rgb(0,0,0,0.5); border-radius:10px; background-color: white;" class="d-flex justify-content-between flex-wrap mb-2 mt-2" id="redGlowNotifyChng">
            @if($usrNotiReg1 != Null)
            <style>  
                @keyframes glowing {
        ...
        <div style="width: 100%; border: 1px solid rgb(0,0,0,0.5); border-radius:10px; background-color: white;" class="d-flex justify-content-between flex-wrap mb-2" id="addProdSound">
            <div style="width: 100%; height:fit-content;" class="d-flex justify-content-between flex-wrap">
        ...
        <div style="width: 100%; border: 1px solid rgb(0,0,0,0.5); border-radius:10px; background-color: white;" class="d-flex justify-content-between flex-wrap mb-2" id="payCloseOrderSound">
            <div style="width: 100%; height:fit-content;" class="d-flex justify-content-between flex-wrap">
