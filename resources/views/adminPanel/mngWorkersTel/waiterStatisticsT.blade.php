...
<div class="pb-5">
    <div class="d-flex">
        ...
        <h6 class="text-center" style="width:33%; color:rgb(39,190,175); padding-top:8px;"><strong>für Takeaway</strong></h6>
    ...
    @include('adminPanel.mngWorkersTel.waiterStatsTaTables.li01')
    @include('adminPanel.mngWorkersTel.waiterStatsTaTables.li02')
    @include('adminPanel.mngWorkersTel.waiterStatsTaTables.li03')
    @include('adminPanel.mngWorkersTel.waiterStatsTaTables.li04')
...
@include('adminPanel.mngWorkersTel.waiterStatJST')