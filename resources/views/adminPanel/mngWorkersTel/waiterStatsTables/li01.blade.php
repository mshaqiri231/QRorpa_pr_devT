...
@if ((isset($_GET['f']) && ($_GET['f'] == 'dateL1A' || $_GET['f'] == 'dateL1Z' || $_GET['f'] == 'idL1A' || $_GET['f'] == 'idL1Z' 
    ...
    @endif
        ...
        <div class="d-flex flex-wrap justify-content-around" style="width: 100%;">
            <p class="text-center" style="width:100%; color:rgb(39,190,175); font-size:1.2rem; margin:0px;"><strong>Bestellungen registriert</strong></p>
        ...
        <div class="p-1 d-flex flex-wrap telTabP" style="width:25% ; border-bottom:1px solid rgb(39,190,175); font-weight:bold;">
            <div class="text-center" style="width: 100%">
            ...
            <span class="ml-2 pt-2" style="width: 100%">Name (Typ)</span>
        </div>
        <div class="p-1 d-flex flex-wrap telTabP" style="width:20% ; border-bottom:1px solid rgb(39,190,175); font-weight:bold;">
            <div class="text-center" style="width: 100%">
            ...
            <span class="ml-2 pt-2" style="width: 100%">Extras</span>
        </div>
        <div class="p-1 d-flex flex-wrap telTabP" style="width:10% ; border-bottom:1px solid rgb(39,190,175); font-weight:bold;">
            <div class="text-center" style="width: 100%">
        ...
        @if(count($li01) > 0)
            ...
            @foreach ($li01 as $oWAL01)
                ...
                @if($to != NULL)
                    ...
                    ?>
                    <p class="telTabP text-center" style="width:15%; margin-bottom:0px; border-bottom:1px dotted rgb(39,190,175);">{{$time2D[0]}}:{{$time2D[1]}} {{$date2D[2]}}.{{$date2D[1]}}.{{$date2D[0]}}</p>
                    <p class="telTabP text-center" style="width:10%; margin-bottom:0px; border-bottom:1px dotted rgb(39,190,175);">{{$to->id}}</p>
                    <p class="telTabP text-center" style="width:10%; margin-bottom:0px; border-bottom:1px dotted rgb(39,190,175);">{{$to->tableNr}}</p>
                    <p class="telTabP text-center" style="width:25%; margin-bottom:0px; border-bottom:1px dotted rgb(39,190,175);">
                    ...
                    <p class="telTabP text-center" style="width:20%; margin-bottom:0px; border-bottom:1px dotted rgb(39,190,175);">
                    ...
                    <p class="telTabP text-center" style="width:10%; margin-bottom:0px; border-bottom:1px dotted rgb(39,190,175);">{{$to->OrderSasia}}</p>
                    <p class="telTabP text-center" style="width:10%; margin-bottom:0px; border-bottom:1px dotted rgb(39,190,175);">{{$to->OrderQmimi}} <span style="opacity: 0.4;">CHF</span></p>
                    <?php
