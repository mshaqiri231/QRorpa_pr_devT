...
<div class="d-flex">
        ...
        <h6 class="text-center" style="width:33%; color:rgb(39,190,175); padding-top:8px;"><strong>für Restaurant</strong></h6>
    ...
    @include('adminPanel.mngWorkersTel.waiterStatsTables.li01')
    @include('adminPanel.mngWorkersTel.waiterStatsTables.li02')
    ...
    <div class="d-flex flex-wrap justify-content-around">
        <p class="text-center" style="width:100%; font-size:1.3rem; color:rgb(39,190,175); margin-bottom:0px;"><strong>Bestellungen</strong></p>
        <div style="width:49%;">
    ...
    <div class="d-flex flex-wrap justify-content-around">
        <p class="text-center" style="width:100%; font-size:1.3rem; color:rgb(39,190,175); margin-bottom:0px;"><strong>Umsatz</strong></p>
        <div style="width:49%;">
...
@include('adminPanel.mngWorkersTel.waiterStatJS')