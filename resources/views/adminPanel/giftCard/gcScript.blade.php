					...
					success: (respo) => {
                        if(respo == 'giftCardNotFound'){
                            ...
                            if(respo['onlinePayStat'] == 0){
                                gcShow += '<div style="width:24.5%; margin:5px 0.25% 5px 0.25%; border:1px solid rgb(72,81,87); border-radius:7px; background-color:rgba(252,228,214,255);" class="d-flex flex-wrap justify-content-between p-1">';
                            }else{
                                gcShow += '<div style="width:24.5%; margin:5px 0.25% 5px 0.25%; border:1px solid rgb(72,81,87); border-radius:7px;" class="d-flex flex-wrap justify-content-between p-1">';
                            }
                            if (respo['gcType'] == 'chf'){
...
//----------------------------------------------------------------------------------------------------------------------------
    ...
    function setChfGCBtn(chfAmount){
        ...
        $('#gcChfInputId').val('');
        $('#gcChfInputId').attr('style','width:19.5%; border-top:none; border-left:none; border-right:none;');
    }
    ...
    function setChfGCInput(){
        if($('#gcChfInputId').val()){
            ...
            $('#gcChfInputId').attr('style','width:19.5%; border-top:none; border-left:none; border-right:none; background-color: rgba(33,136,56,255); color:white;');
			...
			success: (respo) => {
				$.each(respo, function(index, value){
                    if (value.onlinePayStat == 0){
                        showGc = '<div style="width:33%; margin:5px 0.16% 5px 0.16%; border:1px solid rgb(72,81,87); border-radius:7px; background-color:rgba(252,228,214,255);" class="d-flex flex-wrap justify-content-between p-1">';
                    }else{
                        showGc = '<div style="width:33%; margin:5px 0.16% 5px 0.16%; border:1px solid rgb(72,81,87); border-radius:7px;" class="d-flex flex-wrap justify-content-between p-1">';
                    }
					...
					success: (respo) => {
                        if(respo == 'giftCardNotFound'){
                            ...
                            if (respo['gcType'] == 'chf'){
                                ...
                                var showTextLangAdminPTotal = "@lang('adminP.total')";
                                gcShow += '<p style="width:50%; font-weight:bold; color:rgb(72,81,87); margin-bottom:3px; line-height:1;" class="text-center">'+showTextLangAdminPTotal+'</p>';
                            ...
                            var showext = "@lang('adminP.client')";
                            alert(showext);
                        }
