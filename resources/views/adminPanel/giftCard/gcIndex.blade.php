...
<div class="mt-2 mb-4" id="gcDiv">
    ...
    <div class="d-flex flex-wrap justify-content-between">
        ...
        <p style="width:45%; font-size:1.5rem; color:rgb(39,190,175); margin:0px;" class="pl-2 mb-2"><strong>Geschenkkarte</strong></p>

        <div style="width:25%;" class="input-group mb-2">
            <input type="text" style="font-size:1rem;" class="form-control shadow-none" placeholder="Geschenkkartencode" id="searchGCByCodeInp">
            <div class="input-group-append">
                <button class="btn btn-outline-dark shadow-none" style="font-size:1rem;" id="searchGCByCodeBtn" onclick="searchGCByCode()" type="button">Suchen</button>
            </div>
        </div>
        <button style="width:25%; font-size:1rem;" class="btn btn-outline-dark shadow-none mb-2" id="gCSearchByScanModalBtn" data-toggle="modal" data-target="#gCSearchByScanModal">
            Suche per QR-Code
        </button>
        ...
        <button style="width:19.8%;" class="btn btn-success shadow-none" data-toggle="modal" data-target="#addSellAGCModal">
            <strong><i class="fa-solid fa-circle-plus"></i> Eine Geschenkkarte verkaufen</strong>
        </button>
        <button style="width:19.8%;" id="activateGCOpenCameraModalBtn" class="btn btn-success shadow-none" data-toggle="modal" data-target="#activateGCCameraScanModal">
            <strong><i class="fa-solid fa-camera"></i> Zum Aktivieren scannen GK</strong>
        </button>

        <button style="width:19.8%;" class="btn btn-info shadow-none" data-toggle="modal" data-target="#expiredAndFullyUsedGCModal" onclick="showExpAUsedGC()">
            <strong><i class="fa-regular fa-rectangle-list"></i> Abgelaufen und voll genutzt</strong>
        </button>
        <button style="width:19.8%;" class="btn btn-info shadow-none" data-toggle="modal" data-target="#deletedGCModal" onclick="showDeletedGC()">
            <strong><i class="fa-solid fa-trash-can"></i> Gelöscht GK</strong>
        </button>
        <button style="width:19.8%;" class="btn btn-info shadow-none" data-toggle="modal" data-target="#statisticsGCModal" onclick="reloadStatistikenModal()">
        ...
        @foreach (giftCard::where([['toRes',Auth::user()->sFor],['statActive','1'],['expirationDate','>=',$nowDt]])->orderByDesc('created_at')->get() as $oneGC)
            @if ($oneGC->gcSumInChf != $oneGC->gcSumInChfUsed)
                @if ($oneGC->onlinePayStat == 0)
                    <div style="width:24.5%; margin:5px 0.25% 5px 0.25%; border:1px solid rgb(72,81,87); border-radius:7px; background-color:rgba(252,228,214,255);" 
                    class="d-flex flex-wrap justify-content-between p-1">
                @else
                    <div style="width:24.5%; margin:5px 0.25% 5px 0.25%; border:1px solid rgb(72,81,87); border-radius:7px;" class="d-flex flex-wrap justify-content-between p-1">
                @endif
                    @if ($oneGC->gcType == 'chf')
                        <!-- CHF giftCard -->
                        ...
                        <p style="width:50%; font-weight:bold; font-size:1.2rem; color:rgb(72,81,87); margin-bottom:6px; line-height:1;" class="btn text-center pt-2"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-wrap justify-content-between" id="addSellAGCModalBody">
                ...
                <div id="addSellAGCToKartelConAlert" class="mt-1 justify-content-between alert alert-success" style="width:100%; border-radius:5px; display:none;">
                    ...
                    <button style="width:7%; padding:0;" class="btn btn-outline-danger" onclick="cancelGCToKartelCon()"><i class="fa-solid fa-x"></i></button>
                </div>
                ...
                <div style="width:100%; display:flex;" id="gcInChfDiv" class="flex-wrap justify-content-between mt-2">
                    <button id="setChfGC50Btn" style="width:19.5%;" class="btn btn-outline-success shadow-none mb-1" onclick="setChfGCBtn('50')">50.00 CHF</button>
                    <button id="setChfGC100Btn" style="width:19.5%;" class="btn btn-outline-success shadow-none mb-1" onclick="setChfGCBtn('100')">100.00 CHF</button>
                    <button id="setChfGC150Btn" style="width:19.5%;" class="btn btn-outline-success shadow-none mb-1" onclick="setChfGCBtn('150')">150.00 CHF</button>
                    <button id="setChfGC200Btn" style="width:19.5%;" class="btn btn-outline-success shadow-none mb-1" onclick="setChfGCBtn('200')">200.00 CHF</button>
                    <input class="form-control shadow-none mb-1" placeholder="Betrag eingeben" id="gcChfInputId" style="width:19.5%; border-top:none; border-left:none; border-right:none;" type="number" onkeyup="setChfGCInput()">
                </div>
                
                <hr style="width:100%;">

                <p style="width:50%; margin:0;" class="pt-3"><strong>Ablaufdatum der Geschenkkarte:</strong></p>
                <div style="width: 50%;" class="form-group d-flex justify-content-between" id="standardExpDateForGCDiv">
                ...
                <div style="width: 100%;" class="form-group d-flex justify-content-between" id="yearsExpDateForGCDiv">
                    <button class="btn btn-info shadow-none" id="gcExprDateByYears1" style="width:9.9%; font-weight:bold;" onclick=gcExprDateByYears(1)>1 Jahr</button>
                    <button class="btn btn-info shadow-none" id="gcExprDateByYears2" style="width:9.9%; font-weight:bold;" onclick=gcExprDateByYears(2)>2 Jahr</button>
                    <button class="btn btn-info shadow-none" id="gcExprDateByYears3" style="width:9.9%; font-weight:bold;" onclick=gcExprDateByYears(3)>3 Jahr</button>
                    <button class="btn btn-info shadow-none" id="gcExprDateByYears4" style="width:9.9%; font-weight:bold;" onclick=gcExprDateByYears(4)>4 Jahr</button>
                    <button class="btn btn-info shadow-none" id="gcExprDateByYears5" style="width:9.9%; font-weight:bold;" onclick=gcExprDateByYears(5)>5 Jahr</button>
                    <button class="btn btn-info shadow-none" id="gcExprDateByYears6" style="width:9.9%; font-weight:bold;" onclick=gcExprDateByYears(6)>6 Jahr</button>
                    <button class="btn btn-info shadow-none" id="gcExprDateByYears7" style="width:9.9%; font-weight:bold;" onclick=gcExprDateByYears(7)>7 Jahr</button>
                    <button class="btn btn-info shadow-none" id="gcExprDateByYears8" style="width:9.9%; font-weight:bold;" onclick=gcExprDateByYears(8)>8 Jahr</button>
                    <button class="btn btn-info shadow-none" id="gcExprDateByYears9" style="width:9.9%; font-weight:bold;" onclick=gcExprDateByYears(9)>9 Jahr</button>
                    <button class="btn btn-info shadow-none" id="gcExprDateByYears10" style="width:9.9%; font-weight:bold;" onclick=gcExprDateByYears(10)>10 Jahr</button>
                </div>
                

                <div class="modal-body d-flex flex-wrap justify-content-between pt-1" style="width:100%;" id="addSellAGCModalBodySubPart3">
                    <hr style="width:100%;">
                    ...
                    <button id="payGCBtn1" style="width:24.5%; margin:0px;" class="btn btn-warning text-center shadow-none" onclick="payGCCashPayPrep()">
                        <strong>Bar</strong>
                    </button>
                    <button id="payGCBtn2" style="width:24.5%; margin:0px;" class="btn btn-warning text-center shadow-none" onclick="payGCCardPay()">
                        <strong>Karte</strong>
                    </button>
                    @if (Auth::user()->sFor == 40)
                    <button id="payGCBtn13" style="width:24.5%; margin:0px;" class="btn btn-warning text-center shadow-none" disabled>
                        <strong>Online</strong>
                    </button>
                    @else
                    <button id="payGCBtn3" style="width:24.5%; margin:0px;" class="btn btn-warning text-center shadow-none" onclick="payGCOnlinePay()">
                        <strong>Online</strong>
                    </button>
                    @endif
                    <button id="payGCBtn4" style="width:24.5%; margin:0px;" class="btn btn-warning text-center shadow-none" onclick="payGCFaturePayPrep()">
                    ...
                    <div class="alert alert-danger text-center mt-1" style="width:100%; display:none; font-weight:bold;" id="addSellAGCModalErr02">
                    ...
                    <input type="hidden" value="0" id="gcToSellConect">
                </div>
            </div>
        </div>
    </div>
...
@include('adminPanel.giftCard.gcModals')
@include('adminPanel.giftCard.gcScript')