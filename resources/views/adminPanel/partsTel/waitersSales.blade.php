...
<section class="p-3 pb-5">
    <div class="d-flex justify-content-between mt-2 mb-2">
        <h5 style="color:rgb(39,190,175); width:100%;"><strong>Tägliche Umsatzberichte der Kellner</strong></h5>
    </div>
    <hr>
    <div class="d-flex flex-wrap justify-content-start">
        ...
        @foreach (User::where([['sFor',Auth::user()->sFor],['role','55']])->get() as $waOne)
            <button class="btn btn-outline-dark shadow-none mb-1" style="width: 100%;" onclick="showCalWa('{{$waOne->id}}')">
                <strong>
                {{ $waOne->name }}
                <br>
                {{ $waOne->email }}
            ...
            <div id="calDaysForWa{{$waOne->id}}D2" style="width: 100%;" class="d-flex flex-wrap justify-content-start p-1">
                ...
                @while(true)
                    @if(($monthCount >= $waCreatedM && $yearCount == $rwaCreatedY) || $yearCount > $rwaCreatedY )
                        <div id="calDaysForWa{{$waOne->id}}D2" style="width: 100%;" class="d-flex flex-wrap justify-content-between p-1">
...
<!-- Modal -->
<div class="modal" id="salesRepModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="false" 
                ...
                <div class="modal-body ">
                    ...
                    <table class="table table-bordered" id="salesRepModalTbl1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2" class="text-center" style="font-size: 1.4rem;"><strong> Gesamtumsatz : <span class="ml-1 mr-1"  id="totalInCHF">-</span> CHF</strong></td>
                            </tr>
                        </tbody>
                    </table>
                    <hr>
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <td style="font-size:0.8rem;"><strong>Bestellungen bestätigt</strong></td>
                                <td style="font-size:0.8rem;" class="text-center" id="orderClosedNr"> --- </td>
                            </tr>
                            <tr>
                                <td style="font-size:0.8rem;"><strong>Bestellungen bestätigt</strong></td>
                                <td style="font-size:0.8rem;" class="text-center" id="orderClosedChf"> --- </td>
                            </tr>
                            <tr>
                                <td style="font-size:0.8rem;"><strong>Trinkgeld registriert</strong></td>
                                <td style="font-size:0.8rem;" class="text-center" id="bakshish1"> --- </td>
                            </tr>
                            <tr>
                                <td style="font-size:0.8rem;"><strong>Trinkgeld aus Bericht</strong></td>
                                <td style="font-size:0.8rem;" class="text-center" id="bakshish2"> --- </td>
                            </tr>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <td style="font-size:0.8rem;"><strong>Bestellungen bestätigt</strong></td>
                                <td style="font-size:0.8rem;" class="text-center" id="orderClosedNr2"> --- </td>
                            </tr>
                            <tr>
                                <td style="font-size:0.8rem;"><strong>Bestellungen bestätigt</strong></td>
                                <td style="font-size:0.8rem;" class="text-center" id="orderClosedChf2"> --- </td>
                            </tr>
                            <tr>
                                <td style="font-size:0.8rem;"><strong>Trinkgeld registriert</strong></td>
                                <td style="font-size:0.8rem;" class="text-center" id="bakshish12"> --- </td>
                            </tr>
                            <tr>
                                <td style="font-size:0.8rem;"><strong>Trinkgeld aus Bericht</strong></td>
                                <td style="font-size:0.8rem;" class="text-center" id="bakshish22"> --- </td>
                            </tr>
            ...
            $.ajax({
                ...
                success: (respo) => {
                    if(respo != null && respo.c5rp != null){
                        ...
                        $('#totalInCHF').html(parseFloat(respo.totalInChf).toFixed(2));
