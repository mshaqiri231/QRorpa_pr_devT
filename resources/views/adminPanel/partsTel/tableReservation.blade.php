...
<section class="pl-2 pr-2 mb-5">
    <div class="d-flex flex-wrap">
        ...
        <hr style="width:100%; margin-top:4px; margin-bottom:4px;">
        @if($newRezRequests > 0)
            <a class="anchorMy" style="width:100%;" href="{{route('TableReservation.ADIndexRezList')}}"> <button class="btn btn-block button-glow-red" style="background-color:red; color:white; font-weight:bold;"> Tischreservierungsanfragen ({{$newRezRequests}} <i class="far fa-bell"></i> )</button></a>
        @else
            <a class="anchorMy" style="width:100%;" href="{{route('TableReservation.ADIndexRezList')}}"> <button class="btn btn-block" style="background-color:rgb(39,190,175); color:white; font-weight:bold;"> Tischreservierungsanfragen </button></a>
        @endif
        <hr style="width:100%; margin-top:4px; margin-bottom:4px;">
