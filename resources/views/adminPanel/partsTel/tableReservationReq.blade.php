...
<section class="pl-3 pr-3 mb-5">
    <div class="d-flex flex-wrap">
        ...
        <hr style="width:100%; margin-top:4px; margin-bottom:4px;">
        <a class="anchorMy" style="width:100%;" href="{{route('TableReservation.ADIndex')}}"> <button class="btn btn-light btn-block" style=" font-weight:bold; border:1px solid lightgray;">{{__('adminP.tableReservations')}}</button> </a>
    </div>
    ...
    <div class="d-flex flex-wrap justify-content-between mt-2 p-2" id="RezReqAllTel" style="border-top:2px solid black;">
