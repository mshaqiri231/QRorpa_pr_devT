...
<div  class="d-flex flex-wrap justify-content-between pl-2 pr-2">
    <a href="{{route('dash.indexConMngRenditja')}}" style="width:100%;  background-color:rgb(39,190,175); border-radius:15px; color:white; font-size:21px;" class="btn p-2">
...
<div id="showMenu">
    @include('adminPanel.manageContent.showMenu')
</div>

<div id="modalsDiv">
    @include('adminPanel.manageContent.addModals')
    @include('adminPanel.manageContent.addETModals')
    @include('adminPanel.manageContent.editModals')
</div>
