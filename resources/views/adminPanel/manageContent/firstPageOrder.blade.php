...
@if(isset($_GET['cat']))
    ...
    <div class="d-flex justify-content-between" style="width:80%; margin-left:10%;">
        <a href="{{route('dash.indexConMngRenditja')}}" style="color: rgb(39,190,175); width:10%; font-size:22px;"><strong> < {{__('adminP.back')}}</strong></a>
...
@else
    ...
    <div class="p-3 d-flex justify-content-between">
        <h5 style="width:60%;">
            <a href="{{route('dash.indexConMng')}}" style="color: rgb(39,190,175); width:10%; font-size:22px;" class="mr-5"><strong> < {{__('adminP.back')}}</strong></a>
    ...
    <div class="d-flex flex-wrap justify-content-start p-3" id="kategoriListing" style="width: 50%; margin-left:25%;">
        ...
        <div  style="width:100%;" class="mb-3 d-flex flex-wrap categoriesToOrder" data-id="{{ $kat->id }}">
            ...
            @endif
            <a href="{{route('dash.indexConMngRenditja',['cat'=> $kat->id])}}" style="width: 90%;" class="allKatFoto" id="KategoriFoto{{$kat->id}}">
