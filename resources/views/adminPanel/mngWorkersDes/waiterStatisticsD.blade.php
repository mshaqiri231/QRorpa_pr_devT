...
<div class="pb-5">
    <div class="d-flex">
        ...
        <h3 class="text-center" style="width:33%; color:rgb(39,190,175);"><strong>für Delivery</strong></h3>
    ...
    @include('adminPanel.mngWorkersDes.waiterStatsDeTables.li01')
    @include('adminPanel.mngWorkersDes.waiterStatsDeTables.li02')
    @include('adminPanel.mngWorkersDes.waiterStatsDeTables.li03')
    @include('adminPanel.mngWorkersDes.waiterStatsDeTables.li04')
...
@include('adminPanel.mngWorkersDes.waiterStatJSD')