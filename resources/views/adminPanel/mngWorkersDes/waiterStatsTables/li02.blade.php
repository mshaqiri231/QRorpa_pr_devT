...
?>
    ...
    @endif
        ...
        <div class="d-flex justify-content-around" style="width: 100%;">
            <p style="width:45%; color:rgb(39,190,175); font-size:1.6rem; margin:0px;"><strong>Bestellungen bezahlt</strong></p>

            @if(isset($_GET['d1L2']))
            <?php $d12D = explode('-',$_GET["d1L2"]); ?>
            <input style="width: 45px;" value="{{$_GET['d1L2']}}" type="date" id="li02DateOne" onchange="li02DateOneShow()" class="form-control shadow-none">
        ...
        <script>
            ...
            function filterByDateL2(wId, fAct){
                ...
                if(fAct == 'none'){
                    ...
                    if(d1L2 != '' && d2L2 != ''){
                        if(d2L2 > d1L2){
                            window.location = '/admWoMngWaiterStatistics?wi='+wId+'&f2='+fAct+'&d1L2='+d1L2+'&d2L2='+d2L2;
                            exit();

                        }else{ if($('#filterByDateL2Err02').is(":hidden")){$('#filterByDateL2Err02').show(50).delay(4000).hide(50);} }

                    }else if(d1L2 != ''){
                        window.location = '/admWoMngWaiterStatistics?wi='+wId+'&f2='+fAct+'&d1L2='+d1L2;
                        exit();
