...
use SebastianBergmann\CodeCoverage\Report\PHP;
    ...
    $ordsTo0Count = waiterActivityLog::where([['waiterId',$theW->id],['actType','takeawayOrStatChng0']])->count();
    $ordsTo1Count = waiterActivityLog::where([['waiterId',$theW->id],['actType','takeawayOrStatChng1']])->count();
    $ordsTo2Count = waiterActivityLog::where([['waiterId',$theW->id],['actType','takeawayOrStatChng2']])->count();
    $ordsTo3Count = waiterActivityLog::where([['waiterId',$theW->id],['actType','takeawayOrStatChng3']])->count();
...
<div class="pb-5">
    <div class="d-flex">
        ...
        <h3 class="text-center" style="width:33%; color:rgb(39,190,175);"><strong>für Takeaway</strong></h3>
                ...
                <div class="card-body">
                    ...
                    || $_GET['f1'] == 'priceL1A' || $_GET['f1'] == 'priceL1Z'))
                        <div class="col mr-2" onclick="hideList01()" id="displayList01Div">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><span style="opacity:0.45"> </span>{{$ordsTo0Count}}</div>
                ...
                <div class="card-body">
                    ...
                    || $_GET['f2'] == 'priceL2A' || $_GET['f2'] == 'priceL2Z'))
                        <div class="col mr-2" onclick="hideList02()" id="displayList02Div">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><span style="opacity:0.45"> </span>{{$ordsTo1Count}}</div>
                ...
                <div class="card-body">
                    ...
                    || $_GET['f3'] == 'priceL3A' || $_GET['f3'] == 'priceL3Z'))
                        <div class="col mr-2" onclick="hideList03()" id="displayList03Div">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><span style="opacity:0.45"> </span>{{$ordsTo2Count}}</div>
                            <p class="pt-2" style="opacity: 0.4; margin-bottom:0px;" id="displayList03Alert"> Klicken Sie auf , um die Liste auszublenden <i class="far fa-hand-pointer"></i></p>
                        </div>
                    @else
                        <div class="col mr-2" onclick="displayList03()" id="displayList03Div">
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Bestellungen Annulliert</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><span style="opacity:0.45"> </span>{{$ordsTo2Count}}</div>
                            <p class="pt-2" style="opacity: 0.4; margin-bottom:0px;" id="displayList03Alert"> klicken, um die Liste anzuzeigen <i class="far fa-hand-pointer"></i></p>
                        </div>
                    @endif
                        <div class="col-auto">
                            <!-- <i class="fas fa-calendar fa-2x text-gray-300"></i> -->
                ...
                <div class="card-body">
                    ...
                    || $_GET['f4'] == 'priceL4A' || $_GET['f4'] == 'priceL4Z'))
                        <div class="col mr-2" onclick="hideList04()" id="displayList04Div">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><span style="opacity:0.45"> </span>{{$ordsTo3Count}}</div>
                            <p class="pt-2" style="opacity: 0.4; margin-bottom:0px;" id="displayList04Alert"> Klicken Sie auf , um die Liste auszublenden <i class="far fa-hand-pointer"></i></p>
                        </div>
                    @else
                        <div class="col mr-2" onclick="displayList04()" id="displayList04Div">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Bestellungen Abgeschlossen</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><span style="opacity:0.45"> </span>{{$ordsTo3Count}}</div>
                            <p class="pt-2" style="opacity: 0.4; margin-bottom:0px;" id="displayList04Alert"> klicken, um die Liste anzuzeigen <i class="far fa-hand-pointer"></i></p>
                        </div>
                    @endif
                        <div class="col-auto">
                            <!-- <i class="fas fa-calendar fa-2x text-gray-300"></i> -->
    ...
    @include('adminPanel.mngWorkersDes.waiterStatsTaTables.li01')
    @include('adminPanel.mngWorkersDes.waiterStatsTaTables.li02')
    @include('adminPanel.mngWorkersDes.waiterStatsTaTables.li03')
    @include('adminPanel.mngWorkersDes.waiterStatsTaTables.li04')




    <div class="d-flex flex-wrap justify-content-around mt-2">
        <p class="text-center" style="width:24%; font-size:1.1rem; color:rgb(255,196,27); margin-bottom:0px;"><strong>Annehmen #</strong></p>
        <p class="text-center" style="width:24%; font-size:1.1rem; color:rgb(78,115,223); margin-bottom:0px;"><strong>Bestätigt #</strong></p>
        <p class="text-center" style="width:24%; font-size:1.1rem; color:rgb(223,79,100); margin-bottom:0px;"><strong>Annulliert #</strong></p>
        <p class="text-center" style="width:24%; font-size:1.1rem; color:rgb(46,167,72); margin-bottom:0px;"><strong>Abgeschlossen #</strong></p>
        <div style="width:24%;">
    ...
    <div class="d-flex flex-wrap justify-content-around">
        <p class="text-center" style="width:24%; font-size:1.1rem; color:rgb(255,196,27); margin-bottom:0px;"><strong>Annehmen CHF</strong></p>
        <p class="text-center" style="width:24%; font-size:1.1rem; color:rgb(78,115,223); margin-bottom:0px;"><strong>Bestätigt CHF</strong></p>
        <p class="text-center" style="width:24%; font-size:1.1rem; color:rgb(223,79,100); margin-bottom:0px;"><strong>Annulliert CHF</strong></p>
        <p class="text-center" style="width:24%; font-size:1.1rem; color:rgb(46,167,72); margin-bottom:0px;"><strong>Abgeschlossen CHF</strong></p>
        <div style="width:24%;">
...
@include('adminPanel.mngWorkersDes.waiterStatJST')