        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-1" id="groupMngGropL1ModBody">
                ...
                <div class="d-flex flex-wrap justify-content-between">
                    <h4 style="color:rgb(39,190,175);"><strong>Kopieren Sie Ihre Kategoriegruppierung direkt auf Ihre Kellner</strong></h4>
                    @foreach (User::where([['role',55],['sFor',Auth::user()->sFor]])->get() as $oneWai)
                        <button onclick="prepCopyGrToWaiter('{{$oneWai->id}}','{{$oneWai->name}}')" style="width: 33%; margin:0px;" class="btn btn-outline-info shadow-none text-center mb-1"
...
<script>
    ...
    function deleteGL2(){
        $.ajax({
			...
			success: () => {
                var grL1ID = $('#deleteGrL2GrBaseId').val();
                $("#groupMngGropL2List"+grL1ID).load(location.href+" #groupMngGropL2List"+grL1ID+">*","");
                cancelDeleteGL2();
			},
			error: (error) => { console.log(error); }
		});
