                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                @foreach(ekstra::where('toCat', '=', $kats->id)->get() as $ekstras)
                                                                        <li class="list-group-item">
                                                                            {{$ekstras->emri}} 
                                                                            <label class="switch">
                                                                            <input type="checkbox" class="success shadow-none" id="extP{{$ekstras->id}}" 
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                @foreach(LlojetPro::where('kategoria', '=', $kats->id)->get() as $proLl)
                                                                        <li class="list-group-item">
                                                                            {{$proLl->emri}} 
                                                                            <label class="switch">
                                                                            <input type="checkbox" class="success shadow-none" id="LlPro{{$proLl->id}}" 
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                @if ($takeAProd->mwstForPro == 0.00)
                                                    <button id="setMwst{{$takeAProd->id}}Btn0" onclick="setNewMwst('0.00','{{$takeAProd->id}}')" style="width:33%;" class="shadow-none btn btn-dark"><strong>MwST: 0.00 %</strong></button>
                                                    <button id="setMwst{{$takeAProd->id}}Btn1" onclick="setNewMwst('2.60','{{$takeAProd->id}}')" style="width:33%;" class="shadow-none btn btn-outline-dark"><strong>MwST: 2.60 %</strong></button>
                                                    <button id="setMwst{{$takeAProd->id}}Btn2" onclick="setNewMwst('8.10','{{$takeAProd->id}}')" style="width:33%;" class="shadow-none btn btn-outline-dark"><strong>MwST: 8.10 %</strong></button>
                                                @elseif ($takeAProd->mwstForPro == 2.60)
                                                    <button id="setMwst{{$takeAProd->id}}Btn0" onclick="setNewMwst('0.00','{{$takeAProd->id}}')" style="width:33%;" class="shadow-none btn btn-outline-dark"><strong>MwST: 0.00 %</strong></button>
                                                    <button id="setMwst{{$takeAProd->id}}Btn1" onclick="setNewMwst('2.60','{{$takeAProd->id}}')" style="width:33%;" class="shadow-none btn btn-dark"><strong>MwST: 2.60 %</strong></button>
                                                    <button id="setMwst{{$takeAProd->id}}Btn2" onclick="setNewMwst('8.10','{{$takeAProd->id}}')" style="width:33%;" class="shadow-none btn btn-outline-dark"><strong>MwST: 8.10 %</strong></button>
                                                @elseif ($takeAProd->mwstForPro == 8.10)
                                                    <button id="setMwst{{$takeAProd->id}}Btn0" onclick="setNewMwst('0.00','{{$takeAProd->id}}')" style="width:33%;" class="shadow-none btn btn-outline-dark"><strong>MwST: 0.00 %</strong></button>
                                                    <button id="setMwst{{$takeAProd->id}}Btn1" onclick="setNewMwst('2.60','{{$takeAProd->id}}')" style="width:33%;" class="shadow-none btn btn-outline-dark"><strong>MwST: 2.60 %</strong></button>
                                                    <button id="setMwst{{$takeAProd->id}}Btn2" onclick="setNewMwst('8.10','{{$takeAProd->id}}')" style="width:33%;" class="shadow-none btn btn-dark"><strong>MwST: 8.10 %</strong></button>
                                                @endif
                                            </div>
                                        </div>
                                        <!-- Modal footer -->
                                        <div class="modal-footer d-flex justify-content-between">
                                            <button style="width:45%;" type="button" class="btn btn-block btn-danger shadow-none" data-dismiss="modal">{{__('adminP.conclude')}}</button>
                                            <button onclick="editTAProduct('{{$takeAProd->id}}')" style="width:45%;" type="button" class="btn btn-block btn-success shadow-none" data-dismiss="modal">{{__('adminP.save')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
