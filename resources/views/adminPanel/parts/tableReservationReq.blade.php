...
<section class="pl-3 pr-3 mb-5">
    <div class="d-flex justify-content-between">
        ...
        <a class="anchorMy" style="width:33%;" href="{{route('TableReservation.ADIndex')}}"> <button class="btn btn-light btn-block" style=" font-weight:bold;">{{__('adminP.tableReservations')}}</button> </a>
    </div>
    ...
    <div class="d-flex flex-wrap justify-content-between mt-2 p-2" id="RezReqAll" style="border-top:2px solid black;">
