...
<section class="pb-5 pt-1 pl-3 pr-3">
    ...
    <div class="d-flex justify-content-between pt-2">
        ...
        <div style="width:32%; background-color:rgb(39,190,175,0.9); border-radius:30px;" class="text-center p-5">
    ...
    <div class="d-flex flex-wrap justify-content-between" >
        @foreach(ServiceReqCli::where('tores',$resId)->get()->sortByDesc('created_at') as $sReq)
            <div style="width:33%; border:1px solid rgb(39,190,175,0.5); border-radius:5px; font-size:19px;"
             class="p-2 pl-4 pr-4 mb-2 d-flex flex-wrap justify-content-between">
