...
<div class="p-3 pb-5">
    <div class="d-flex">
        <a href="{{route('dash.statistics')}}" class="pl-4" style="width: 10%; color:rgb(39,190,175);"><strong><i class="fas fa-2x fa-chevron-left"></i></strong></a>
    ...
    @include('adminPanel.salesStatistics.desktopph1')
    @include('adminPanel.salesStatistics.desktopph1_5')
    @include('adminPanel.salesStatistics.desktopV1SelectRes')

    @include('adminPanel.salesStatistics.desktopph2')

    @include('adminPanel.salesStatistics.desktopph2Day')
    @include('adminPanel.salesStatistics.desktopph2Week')
    @include('adminPanel.salesStatistics.desktopph2Month')
    @include('adminPanel.salesStatistics.desktopph2Year')

    @include('adminPanel.salesStatistics.desktopph3')
        ...
        <table style="width:80%; margin-left:10%;" id="VerkaufsstatistikenPH4Table2" class=" table table-hover">
            <thead>
                <tr>
                    ...
                    <th id="exportToPDFSalesMonthAllSel" colspan="2" class="text-center text-primary">
