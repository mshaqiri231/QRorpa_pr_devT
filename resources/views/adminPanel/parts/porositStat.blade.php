...
@include('words')
@foreach(OrdersPassive::where('Restaurant',$thisRestaurantId)->get() as $order)
    @if ($order->statusi != '2')
        <?php
...
<?php
    ...
    $gcSalesThisDay = number_format(giftCard::where([['toRes',Auth::user()->sFor],['oldGCtransfer','0']])->whereDate('created_at',$nowDate)->sum('gcSumInChf'), 2, '.', '');
    $gcSalesThisMonth = number_format(giftCard::where([['toRes',Auth::user()->sFor],['oldGCtransfer','0']])->whereYear('created_at', $nowYear)->whereMonth('created_at', $nowMonth)->sum('gcSumInChf'), 2, '.', '');
 ...
 <div class="col-12 pb-4" id="porositStat">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800" style="width:50%;">{{__('adminP.dashboard')}}</h1>
            ...
            <div class="row">
                <!-- Earnings (Monthly) Card Example -->
                    <div class="col-xl-4 col-md-6 mb-4">
                        <a class="nostyle" href="{{route('dash.dash01')}}">
                    ...
                    <div class="col-xl-4 col-md-6 mb-4">
                        <a class="nostyle" href="{{route('dash.dash02')}}">
                    ...
                    <div class="col-xl-4 col-md-6 mb-4">
                        <a class="nostyle" href="{{route('dash.dashCanceled')}}">
                    ...
                    <div class="col-xl-4 col-md-6 mb-4">
                        <div class="card border-left-info shadow h-100 py-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{number_format($done, 2, '.', '')}}%</div>
                                    </div>
                                    <div class="col">
                    ...
                    <div class="col-xl-4 col-md-6 mb-4">
                        <a class="nostyle" href="{{route('dash.statBillsPage')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 mb-4">
                        <a class="nostyle" href="{{route('dash.statsDeletedTAProdsPage')}}">
                            <div class="card border-left-dark shadow h-100 py-2">
                                <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><span style="opacity:0.45">Instanzen : </span>
                                            {{tabOrderDelete::where([['toRes',Auth::user()->sFor],['byId','!=','441'],['byId','!=','442'],['byId','!=','443']])->whereMonth('created_at',Carbon::now()->month)->whereYear('created_at',Carbon::now()->year)->get()->count()}}
                                        </div>
                                    </div>
                                    <div class="col-auto">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 text-center">
                        <a class="nostyle" href="{{route('admin.waDailySalesPage')}}">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                    ...
                    <div class="col-xl-6 col-md-6 text-center">
                        <a class="nostyle" href="{{route('dash.rechnungPage')}}">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                ...
                <div class="row mt-3">
                    <!-- Sales statistics -->
                    <div class="col-xl-6 col-md-6 text-center">
                        <a class="nostyle" href="{{route('dash.salesStatistics')}}">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div style="font-size: 23px;" class="font-weight-bold text-dark text-uppercase mb-1"><strong>{{__('adminP.salesStatistics')}} <i class="ml-4 fas fa-cash-register"></i></strong></div>
                    ...
                    <!-- categorize for reports -->
                    <div class="col-xl-6 col-md-6 text-center">
                        <a class="nostyle" href="{{route('admin.categorizeReport')}}">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <a class="nostyle" href="{{route('admWoMng.openCheckInOutReports')}}">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
