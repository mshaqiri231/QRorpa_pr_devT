        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="payAllProdsCashBody">
                ...
                <div id="payAllPCMDiv1" class="d-flex flex-wrap justify-content-between">
                    <button style="width: 75px; height:75px; border-radius:50%; margin:0px; background-color:rgba(204,153,0,255); font-size:1.2rem; color:white;" class="shadow-none btn mb-2 currBtn" onclick="addClPay('0.05')"><strong>5 <br> Rp.</strong></button>
                    <button style="width: 75px; height:75px; border-radius:50%; margin:0px; background-color:rgba(208,206,207,255); font-size:1.2rem; color:white;" class="shadow-none btn mb-2 currBtn" onclick="addClPay('0.1')"><strong>10 <br> Rp.</strong></button>
                    <button style="width: 75px; height:75px; border-radius:50%; margin:0px; background-color:rgba(208,206,207,255); font-size:1.2rem; color:white;" class="shadow-none btn mb-2 currBtn" onclick="addClPay('0.2')"><strong>20 <br> Rp.</strong></button>
                    <button style="width: 75px; height:75px; border-radius:50%; margin:0px; background-color:rgba(208,206,207,255); font-size:1.2rem; color:white;" class="shadow-none btn mb-2 currBtn" onclick="addClPay('0.5')"><strong>50 <br> Rp.</strong></button>
                    <button style="width: 75px; height:75px; border-radius:50%; margin:0px; background-color:rgba(208,206,207,255); font-size:1.2rem; color:white;" class="shadow-none btn mb-2 currBtn" onclick="addClPay('1')"><strong>CHF <br> 1</strong></button>
                    <button style="width: 75px; height:75px; border-radius:50%; margin:0px; background-color:rgba(208,206,207,255); font-size:1.2rem; color:white;" class="shadow-none btn mb-2 currBtn" onclick="addClPay('2')"><strong>CHF <br> 2</strong></button>
                    <button style="width: 75px; height:75px; border-radius:50%; margin:0px; background-color:rgba(208,206,207,255); font-size:1.2rem; color:white;" class="shadow-none btn mb-2 currBtn" onclick="addClPay('5')"><strong>CHF <br> 5</strong></button>
                </div>
    ...
    function payAllProdsCash(){
        if(hasSndNotiActv == 1){
            if(hasPayOrdSoundSelected == 1){
                $("#soundsAllNBAP").html('<audio id="soundsAllNAPAudio" src="storage/sound/{{$usrNotiReg31Sound->soundTitle}}.{{$usrNotiReg31Sound->soundExt}}" autoplay="true"></audio>');
            }else{
