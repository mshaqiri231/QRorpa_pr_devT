...
@include('adminPanel.taTempProdTel.payMethodsScript')
@include('adminPanel.taTempProdTel.payCashModal')
@include('adminPanel.taTempProdTel.payRechnungModal')
    ...
    function addToCartExpressTATemp(taProId,notiAct){
        ...
        if(notiAct == 1){
            if(hasAddSoundSelected == 1){
                $("#soundsAllNBAP").html('<audio id="soundsAllNAPAudio" src="storage/sound/{{$usrNotiReg21Sound->soundTitle}}.{{$usrNotiReg21Sound->soundExt}}" autoplay="true"></audio>');
            }else{
                $("#soundsAllNBAP").html('<audio id="soundsAllNAPAudio" src="storage/sound/addOrCloseByStaf.mp3" autoplay="true"></audio>');
            }
        }
        $.ajax({
