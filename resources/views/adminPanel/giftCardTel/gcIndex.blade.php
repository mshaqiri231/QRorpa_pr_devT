        ...
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-wrap justify-content-between" id="addSellAGCModalBody">
                ...
                <div class="modal-body d-flex flex-wrap justify-content-between" style="width:100%;" id="addSellAGCModalBodySubPart3">
                    ...
                    <button id="payGCBtn3" style="width:49.5%; margin:0px;" class="mt-1 btn btn-warning text-center shadow-none" disabled>
                        <strong>Online</strong>
                    </button>
                    @else
                    <button id="payGCBtn3" style="width:49.5%; margin:0px;" class="mt-1 btn btn-warning text-center shadow-none" onclick="payGCOnlinePay()">
                        <strong>Online</strong>
                    </button>
                    @endif
...
@include('adminPanel.giftCardTel.gcModals')
@include('adminPanel.giftCardTel.gcScript')