...
@if(isset($_GET['cat']))
    ...
    <div class="d-flex flex-wrap justify-content-between p-3" style="width:100%;">
        ...
        <a href="{{route('dash.indexConMngRenditja')}}" style="color: rgb(39,190,175); width:55%; font-size:17px;"><strong> < {{__('adminP.back')}}</strong></a>
...
@else
    ...
    <div class="p-3 d-flex flex-wrap justify-content-between">
        <h3 style="width:100%;">
            <a href="{{route('dash.indexConMng')}}" style="color: rgb(39,190,175); width:10%; font-size:19px;" class="mr-5"><strong> < {{__('adminP.back')}}</strong></a>
    ...
    <div class="d-flex flex-wrap justify-content-start p-3" id="kategoriListingTel" style="width: 100%;">
        ...
        <div style="width:100%;" class="mb-3 d-flex flex-wrap justify-content-between categoriesToOrderTel" data-id="{{ $kat->id }}">
            ...
            @endif
            <a href="{{route('dash.indexConMngRenditja',['cat'=> $kat->id])}}" style="width: 85%;" class="allKatFoto" id="KategoriFoto{{$kat->id}}Tel">
