...
@section('content')
    ...
    <div class="container" style="margin-top:3cm;">
        <h2 style="color:rgb(39,190,175);" class="text-center"><strong>QRorpa Kassensysteme GmbH</strong></h2>
        <h4 style="color:rgb(72,81,87);" class="text-center"><strong>Kontaktlos bestellen und bezahlen</strong></h4>
        <h4 style="color:rgb(72,81,87);" class="text-center"><strong>QR-Code scann, Order & Pay</strong></h4>

        <h2 style="color:rgb(72,81,87); margin-top:0.7cm;" class="text-center"><strong>Impressum, AGB und Datenschutz</strong></h2>
