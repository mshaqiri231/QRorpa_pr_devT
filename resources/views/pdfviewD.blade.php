    ...
    <div class="invoice-box" style="margin-top:-14px;">
        <table cellpadding="0" cellspacing="0">
            <tr class="d-flex justify-content-between" > 
                ...
                <td  style="width:28%; padding-top:-20px; text-align:left; padding-left:30px;">
                ...
                <td class="text-right" style="width:32%; text-align:right;">
            ...
            <tr class="information">
                <td style="padding-left:8mm;">
                    <table style="margin-top:1.4cm;">
                        ...
                        <tr>
                            <td colspan="2" style="font-size: 11pt; line-height: 1.5; margin-top:-15px;">
                               {{$items->emri}}<br>
                                {{$items->adresa}}<br>
                                {{$items->plz}} {{$items->ort}}
                ...
                <td colspan='2' style="text-align:right;"><br>
                    ...
                    <img width="90px" src="{{ public_path() . '/storage/images/qr-code-admin-benutzung-2.png' }}" />
