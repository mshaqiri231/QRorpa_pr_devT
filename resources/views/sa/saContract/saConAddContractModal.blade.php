        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="addANewContractModalBody">
                <form action="{{ route('saContracts.addNew') }}" id="saContractsAddNew" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-flex">
                        <div class="input-group" style="width: 35%; margin-right:2%">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="addNCon_name_span">Vorname*</span>
                            </div>
                            <input id="addNCon_name" name="addNCon_name" type="text" class="form-control shadow-none" value="">
                        </div>
                        <div class="input-group" style="width: 35%; margin-right:2%">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="addNCon_lastname_span">Nachname*</span>
                            </div>
                        ...
                        <div class="input-group" style="width:26%;">
                            <div class="input-group-prepend">
                                <label class="input-group-text" for="addNCon_gender">Geschlecht:*</label>
                            </div>
                    ...
                    <div class="d-flex mt-2">
                        <div class="input-group" style="width: 35%; margin-right:2%">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-default">Strasse/Nr.*</span>
                            </div>
                    ...
                    <div class="d-flex mt-2">
                        <div class="input-group" style="width: 35%; margin-right:2%">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-default">Firmenname*</span>
                            </div>
                    ...
                    <div class="d-flex mt-2">
                        <div class="input-group" style="width: 100%;">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Kreditkartennummer*</span>
                            </div>
                            <div class="input-group-prepend">
                        ...
                        <div class="card" style="width: 100%;">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex flex-wrap justify-content-between" style="padding:3px;">
                                    <span style="width:24.5%;" class="badge badge-success">✓ Kontaktlos bestellen und bezahlen</span>
                                    <span style="width:24.5%;" class="badge badge-success">✓ Serviceteam über System rufen</span>
                                    <!-- <span style="width:24.5%;" class="badge badge-success">✓ Covid-19 Kontaktformular</span> -->
                                    <span style="width:24.5%;" class="badge badge-success">✓ Empfohlene Produkte</span>
                                    <span style="width:24.5%;" class="badge badge-success mt-1">✓ Produkt Management</span>
                                    <span style="width:24.5%;" class="badge badge-success mt-1">✓ Tischwechsel</span>
                                    <span style="width:24.5%;" class="badge badge-success mt-1">✓ Trinkgeld</span>
                                    <span style="width:24.5%;" class="badge badge-success mt-1">✓ Gratis Produkte anbieten</span>
                                    <!-- <span style="width:24.5%;" class="badge badge-success mt-1">✓ Gratis Produkte</span> -->
                                    <!-- <span style="width:24.5%;" class="badge badge-success mt-1">✓ Gratis Produkte anbieten</span> -->
                                    <span style="width:24.5%;" class="badge badge-success mt-1">✓ Gutscheincode</span>
                                    <span style="width:24.5%;" class="badge badge-success mt-1">✓ Kundenbindung</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="d-flex mt-2" id="conDivToAddTables">
                        <div class="input-group" style="width: 100%;">
                            ...
                            <input type="text" id="addNCon_tables" name="addNCon_tables" class="form-control shadow-none" onkeyup="countAddNConTablesAmount(this.value)">
                            <div class="input-group-append">
                                <span class="input-group-text">z.B.: 1-10,20-25 (1 bis 10 und 20 bis 25)</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between mt-2">
                        <button type="button" class="btn btn-dark" style="width:9%"><span id="addNCon_tables_amount">0</span> <i class="fas fa-border-all"></i></button>
                        <button type="button" id="addNCon_tables1" onclick="selectTablePayment('0','0','0','0')" style="width:30%;" class="btn serviceBtn">#</button>
                        <button type="button" id="addNCon_tables2" onclick="selectTablePayment('0','0','0','0')" style="width:30%;" class="btn serviceBtn">#</button>
                        <button type="button" id="addNCon_tables3" onclick="selectTablePayment('0','0','0','0')" style="width:30%;" class="btn serviceBtn">#</button>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item" style="padding:3px;">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Einrichtung, Flyer, Tischkartenhalter, Schulung</span>
                                        </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-between mt-2">
                        ...
                        <div class="input-group" style="width: 100%;">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="">Benutzername / E-Mail / Paswwort</span>
                            </div>
                            <input type="text" id="newRegAdminsUsername" class="form-control shadow-none">
                            <input type="text" id="newRegAdminsEmail" class="form-control shadow-none">
                            <input type="text" id="newRegAdminsPassword" class="form-control shadow-none">
                            <div class="input-group-append">
                                <button class="btn btn-dark" onclick="addNewRegAdmins()" type="button"><i class="fas fa-xl fa-user-plus"></i></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-between mt-2">
                        ...
                        <button type="button" id="addNCon_Takeaway" style="width:20%;" class="btn serviceBtn02">Takeaway</button>
                        <button onclick="selectTakeawayPay('19','1','0','0')" type="button" id="addNCon_Takeaway1" style="width:32%;" class="btn serviceBtn">19 <sub>CHF</sub>/Monat +1% provision</button>
                        <button onclick="selectTakeawayPay('0','0','39','0')" type="button" id="addNCon_Takeaway2" style="width:32%;" class="btn serviceBtn">39 <sub>CHF</sub>/Monat</button>
                        <button onclick="selectTakeawayPay('0','0','0','7')" type="button" id="addNCon_Takeaway3" style="width:14%;" class="btn serviceBtn">7%</button>
                        <button type="button" id="addNCon_Delivery"  style="width:20%;" class="btn serviceBtn02 mt-2">Delivery</button>
                        <button onclick="selectDeliveryPay('19','1','0','0')" type="button" id="addNCon_Delivery1" style="width:32%;" class="btn serviceBtn mt-2">19 <sub>CHF</sub>/Monat +1% provision</button>
                        <button onclick="selectDeliveryPay('0','0','39','0')" type="button" id="addNCon_Delivery2" style="width:32%;" class="btn serviceBtn mt-2">39 <sub>CHF</sub>/Monat</button>
                        <button onclick="selectDeliveryPay('0','0','0','7')" type="button" id="addNCon_Delivery3" style="width:14%;" class="btn serviceBtn mt-2">7%</button>
                        ...
                        <button type="button" id="addNCon_Tischreservierung" onclick="addTischreservierung('29')"  style="width:33%;" class="btn serviceBtn mt-2">Tischreservierung +29 <sub>CHF</sub>/Monat</button>
                        <button type="button" id="addNCon_Warenwirtschaft" onclick="addWarenwirtschaft('49')"  style="width:33%;" class="btn serviceBtn mt-2">Warenwirtschaft +49 <sub>CHF</sub>/Monat</button>
                        <button type="button" id="addNCon_Personalvertretung" onclick="addPersonalvertretung('19')"  style="width:33%;" class="btn serviceBtn mt-2">Personalverwaltung +19 <sub>CHF</sub>/Monat</button>
                    ...
                    <div class="d-flex flex-wrap justify-content-between mt-2">
                        ...
                        <div class="input-group" style="width: 49%; font-weight:bold; display:none;">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group mt-2" style="width: 32%; font-weight:bold;">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Am Tisch</span>
                            </div>
                        ...
                        <div class="input-group mt-2" style="width: 32%; font-weight:bold;">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Takeaway</span>
                            </div>
                    ...
                    <div class="d-flex mt-2">
                        <div class="card" style="width: 100%;">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex" style="padding:3px;">
                                    <p style="width:49%; margin:3px;" class="pl-3"><strong>SMS-Gateway Bestellungen verifizieren :</strong></p>
                                    <p style="width:49%; margin:3px;" class="text-right pr-3"><strong>CHF 0.10.- pro SMS</strong></p>
                                </li>
                                <!-- <li class="list-group-item d-flex" style="padding:3px;">
                                    <p style="width:49%; margin:3px;" class="pl-3"><strong>Online-Zahlungen: Twint</strong></p>
                                    <p style="width:49%; margin:3px;" class="text-right pr-3"><strong>1.4% + CHF 0.28.- pro Transaktion</strong></p>
                                </li>
                                <li class="list-group-item d-flex" style="padding:3px;">
                                    <p style="width:49%; margin:3px;" class="pl-3"><strong>Online-Zahlungen: PostFinance Card</strong></p>
                                    <p style="width:49%; margin:3px;" class="text-right pr-3"><strong>1.9% + CHF 0.28.- pro Transaktion</strong></p>
                                </li>
                                <li class="list-group-item d-flex" style="padding:3px;">
                                    <p style="width:49%; margin:3px;" class="pl-3"><strong>Online-Zahlungen: PostFinance E-Service</strong></p>
                                    <p style="width:49%; margin:3px;" class="text-right pr-3"><strong>1.9% + CHF 0.28.- pro Transaktion</strong></p>
                                </li>
                                <li class="list-group-item d-flex" style="padding:3px;">
                                    <p style="width:49%; margin:3px;" class="pl-3"><strong>Online-Zahlungen: MasterCard</strong></p>
                                    <p style="width:49%; margin:3px;" class="text-right pr-3"><strong>1.9% + CHF 0.28.- pro Transaktion</strong></p>
                                </li>
                                <li class="list-group-item d-flex" style="padding:3px;">
                                    <p style="width:49%; margin:3px;" class="pl-3"><strong>Online-Zahlungen: Visa</strong></p>
                                    <p style="width:49%; margin:3px;" class="text-right pr-3"><strong>1.9% + CHF 0.28.- pro Transaktion</strong></p>
                                </li> -->
                            </ul>
                        </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-between mt-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-bars mr-3"></i> Menükarte/Getränkekarte hochladen:</span>
                            </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-between mt-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-bars mr-3"></i> UID hochladen:</span>
                            </div>
                            <div class="custom-file">
                    ...
                    <div class="d-flex flex-wrap justify-content-between mt-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-bars mr-3"></i> Pass/ID hochladen:</span>
                            </div>
                            <div class="custom-file">
                    ...
                    <div class="d-flex flex-wrap justify-content-between mt-2">
                        ...
                        <div style="width: 59%;" class="mt-2 d-flex justify-content-between" id="signatureDiv">
