<script>
        ...
        if(verNr != contrVer){
            ...
            $('#addANewContractModalBody').load(location.href+" #addANewContractModalBody>*", function() {
                if(verNr == 1){
                    ...
                    $('#addNCon_tables2').attr('style','width:45%');
                    $('#addNCon_tables3').attr('style','width:45%');

                    $('#addNCon_Takeaway1').hide(50);
                    $('#addNCon_Takeaway2').attr('style','width:48%');
                    ...
                    $('#addNCon_Delivery2').attr('style','width:48%');
            ...
            if (!istabFoValid) {
                ...
                if(contrVer == 1){
                    if(countTab <= 0){ 
                        ...
                        $('#addNCon_tables1').html('799 <sub>CHF</sub>/monat +1% provision'); 
                        $('#addNCon_tables2').html('1299 <sub>CHF</sub>'); 
                        $('#addNCon_tables3').html('5%');
    ...
    function addNewRegAdmins(){
        ...
        $.when(checkEmailUsage(email)).done(function(emailIsInUse){
            ...
            if(!$('#newRegAdminsUsername').val() || !$('#newRegAdminsEmail').val() || !$('#newRegAdminsPassword').val()){
                ...
                $('#addANewContractModalAdminsDiv').append('<button style="width: 5%;" class="btn btn-danger mt-1" onclick="removeAdminIns(\''+adminCount+'\')"><i class="fas fa-times"></i></button>');
                $('#addANewContractModalAdminsDiv').append('<p id="adminInc1_'+adminCount+'" class="text-center mt-1" style="width:19.5%;"><strong>Administratorin '+adminCount+': </strong></p>');
                $('#addANewContractModalAdminsDiv').append('<p id="adminInc2_'+adminCount+'" class="text-center mt-1" style="width:24.5%;"><i class="fas fa-user"></i> <span id="adminInc2_'+adminCount+'Val">'+userN+'</span> </p>');
                $('#addANewContractModalAdminsDiv').append('<p id="adminInc3_'+adminCount+'" class="text-center mt-1" style="width:24.5%;"><i class="fas fa-at"></i> <span id="adminInc3_'+adminCount+'Val">'+email+'</span> </p>');
                $('#addANewContractModalAdminsDiv').append('<p id="adminInc4_'+adminCount+'" class="text-center mt-1" style="width:24.5%;"><i class="fas fa-lock"></i> <span id="adminInc4_'+adminCount+'Val">'+pass+'</span> </p>');
    ...
    function removeAdminIns(admIncNumber){
        ...
        $('#adminInc1_'+admIncNumber).attr('style','width:19.5%; text-decoration: line-through;');
        $('#adminInc2_'+admIncNumber).attr('style','width:24.5%; text-decoration: line-through;');
        $('#adminInc3_'+admIncNumber).attr('style','width:24.5%; text-decoration: line-through;');
        $('#adminInc4_'+admIncNumber).attr('style','width:24.5%; text-decoration: line-through;');
    }
