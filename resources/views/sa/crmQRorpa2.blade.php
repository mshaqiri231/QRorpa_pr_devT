...
<div class="container-fluid mb-3" style="margin-top:20px; min-width:1200px;">
    <div class="row" style="width:100%;">
        ...
        <div class="col-12 mt-5">
                    ...
                    <div style="margin-top:-50px;" class="d-flex justify-content-between" id="topShowNumberCRM">
                        <h3 style="width:70%" class="pl-3">{{$resDemoSearchResult->count()}} X Results</h3>
                        <a href="{{route('resDemo.indexCRM')}}" style="width:70%"><button class="btn btn-block btn-default text-right pr-3">Show All</button> </a>
                    </div>
                ...
                <ul class="list-group" id="SearchDemoUL">
                    ...
                    @foreach($resDemoSearchResult as $resDemoBeta)
                        ...
                        <li class="list-group-item" id="ResDemoLine{{$resDemoBeta->id}}">
                            ...
                            <div class="d-flex justify-content-between">
                                    ...
                                    <div style="width:25%" class="mt-3 selectiveResDemo d-flex flex-wrap justify-content-around" >
                                        <p onclick="selectThisResDemo('{{$resDemoBeta->id}}')" style="font-size:21px; width:100%;"><strong >{{$resDemoBeta->emri}}</strong></p>
