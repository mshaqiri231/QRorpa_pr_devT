        ...
        <div style="width: 100%;" class="d-flex flex-wrap justify-content-between p-1">
            ...
            ?>
                @while(true)
                    ...
                    <p style="width:12%;" class="text-right pr-2"><strong >
                        <?php
                            switch($monthCount){
                    ...
                    <div style="width:88%;" class="d-flex flex-wrap justify-content-between mb-2">
                        @for($i=1;$i<=$month->daysInMonth;$i++)
                            ...
                            @if($dateCheckCreate >= $theRes->created_at)
                                <button class="btn btn-outline-dark" onclick="selectPH21('{{$dateCheckCreate}}')" style="width:6.24%;">{{$i}}</button>
                            @else
                               <button class="btn btn-outline-dark" style="width:6.24%;"></button>
                            @endif
                        @endfor
                            ...
                            <?php
                                ...
                                switch($empty){
                                    case 1:
                                        echo '<button class="btn btn-outline-dark" style="width:6.24%;"></button> '; 
                                        echo '<button class="btn btn-outline-dark" style="width:6.24%;"></button> '; 
                                    break;
                                    case 2:
                                        echo '<button class="btn btn-outline-dark" style="width:6.24%;"></button> '; 
