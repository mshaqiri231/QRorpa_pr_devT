...
<div  class="d-flex flex-wrap justify-content-between pl-2 pr-2">
    <a href="{{route('admWoMng.adminWoContentMngOrderWaiter')}}" style="width:100%;  background-color:rgb(39,190,175); border-radius:15px; color:white; font-size:21px;" class="btn p-2">
...
<div id="showMenu">
    @include('adminPanelWaiter.manageContent.showMenu')
</div>

<div id="modalsDiv">
    @include('adminPanelWaiter.manageContent.addModals')
    @include('adminPanelWaiter.manageContent.addETModals')
    @include('adminPanelWaiter.manageContent.editModals')
</div>
