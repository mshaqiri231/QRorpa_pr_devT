        ...
        <div class="modal-content">
            <div class="modal-body" style="padding:2px;">
                ...
                <div class="pt-2 pb-5 pr-1 pl-1">
                    <h6 class="pl-2" style="color:rgb(39,190,175);">
                        <strong>
                            Registrieren Sie eine neue Takeaway-Bestellung
                        </strong>
                        <button type="button" class="close" aria-label="Close" onclick="closeAddOrForTAModal()">
                            <span aria-hidden="true">X</span>
                        </button>
                    </h6>
                    <div id="addOrForTAModalBody2" class="d-flex flex-wrap justify-content-between mt-3">
                        <div id="addOrForTAModalBody2Left" style="width:100%">
                                ...
                                <div id="addOrForTAModalBody2LeftCats" class="swiper-wrapper p-2"> 
                                    ...
                                    @foreach(range(0, count($catsArrayP1)-1) as $nrRnd)
                                        ...
                                        <div class="swiper-slide mr-1" style=" width:64px; height:85px;">
                                            @if($kat != 'none')
                                                <img class="{{ $catShowFirst == 0 ? 'taNewProCatSel' : '' }}" id="taNewProdCatImg{{$kat->id}}"
                                            ...
                                            @if($kat2 != 'none')
                                                <img class="mr-1 swiper-slide {{ $catShowFirst == 0 ? 'taNewProCatSel' : '' }}" id="taNewProdCatImg{{$kat2->id}}"
                                                style="border-radius:5px; width:64px; height:40px;" src="storage/kategoriaUpload/{{$kat2->foto}}"alt=""
                                                onclick="selectShowCatTaNewProds('{{$kat2->id}}')">
                                                <?php 
                                    ...
                                    style="border-radius:5px; width:64px; height:85px;" src="storage/kategoriaUpload/whiteCat.JPG" alt="">
                                    <img class="mr-1 swiper-slide " id="taNewProdCatImg000"
                                    style="border-radius:5px; width:64px; height:85px;" src="storage/kategoriaUpload/whiteCat.JPG" alt="">
                            ...
                            @foreach ($taCats as $taCatsOneId)
                                ...
                                <div class="flex-wrap justify-content-start" style="width:100%; max-height:614px; overflow-y:scroll; display:flex;" id="taNewProdCat{{$taCatsOneId}}Prods">
                                @else
                                <div class="flex-wrap justify-content-start" style="width:100%; max-height:614px; overflow-y:scroll; display:none;" id="taNewProdCat{{$taCatsOneId}}Prods">
                                @endif
                                    ...
                                    @foreach(Takeaway::where('toRes', '=', Auth::user()->sFor)->where('kategoria','=',$taCatsOneId)->orderByDesc('created_at')->get() as $ketoProd)
                                        <div class="d-flex justify-content-between" style="width:49.5%; margin: 4px 0.25% 4px 0.25%; border:1px solid rgb(39,190,175); border-radius:0.25rem;">
                                            <div style="width:80%;" class="p-1" data-toggle="modal" data-target="#ProdNewTATemp{{$ketoProd->id}}" onclick="checkInOpenProdNewTATemp('{{$ketoProd->id}}')">
                                            ...
                                            @else
                                            <button onclick="checkInOpenTypeSelect('{{$ketoProd->id}}')" class="btn btn-outline-dark shadow-none" style="width:20%; height:100%; margin:0px; padding:1px;">
                                            @endif
                        ...
                        <div id="addOrForTAModalBody2Right" style="width:100%; min-height: 810px; border:1px solid rgb(39,190,175); border-radius:6px;  position: relative;" 
                        class="p-1 d-flex flex-wrap justify-content-between">
                            ...
                            style="position: absolute; top: 24px; left:2px; right:2px; max-height:225px; overflow-y:scroll;">
                                <?php
                            ...
                            style="position: absolute; bottom: 2px; left:2px; right:2px;">
                                ...
                                <div class="d-flex flex-wrap justify-content-between" id="payAllPhaseOneDiv5">
                                    <p class="text-center" style="width:100%; color:rgb(72,81,87); margin:0;"><strong>Tipp</strong></p>
                                    <button onclick="setTipStaf('tipWaiter50','0.5')" id="tipWaiter50" style="width:19.2%; margin:0px; font-size:0.8rem;" type="button" class="btn btn-outline-dark shadow-none mt-2"><strong>50</strong> <sup>CHF</sup></button>
                                    <button onclick="setTipStaf('tipWaiter1','1')" id="tipWaiter1" style="width:19%; margin:0px; font-size:0.8rem;" type="button" class="btn btn-outline-dark shadow-none mt-2"><strong>1</strong> <sup>CHF</sup></button>
                                    <button onclick="setTipStaf('tipWaiter2','2')" id="tipWaiter2" style="width:19%; margin:0px; font-size:0.8rem;" type="button" class="btn btn-outline-dark shadow-none mt-2"><strong>2</strong> <sup>CHF</sup></button>
                                    <button onclick="setTipStaf('tipWaiter5','5')" id="tipWaiter5" style="width:19%; margin:0px; font-size:0.8rem;" type="button" class="btn btn-outline-dark shadow-none mt-2"><strong>5</strong> <sup>CHF</sup></button>
                                    <button onclick="setTipStaf('tipWaiter10','10')" id="tipWaiter10" style="width:19.2%; margin:0px; font-size:0.8rem;" type="button" class="btn btn-outline-dark shadow-none mt-2"><strong>10</strong> <sup>CHF</sup></button>
                                ...
                                <p style="width:100%; color:rgb(39,190,175); margin-top:6px; margin-bottom:6x;" class="text-center">
                                    <strong>Zahlungeart</strong>
                                </p>
...
<script>
    ...
    function selectShowCatTaNewProds(kId){
        if(openCatTaNewPro != 0){
            $('#taNewProdCat'+openCatTaNewPro+'Prods').attr('style','width:100%; max-height:614px; overflow-y:scroll; display:none;');
            $('#taNewProdCatImg'+openCatTaNewPro).removeClass('taNewProCatSel');
        }
        openCatTaNewPro = kId;
        $('#taNewProdCat'+kId+'Prods').attr('style','width:100%; max-height:614px; overflow-y:scroll; display:flex;');
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    echo '
                                        style="background-color:rgb(39,190,175); color:white; border-radius:30px; position:fixed; height:70px; width:96%; bottom:50px;
                                        right:2%; left:2%; font-size:22px;" id="sendOrderBtn'.$prod->id.'"
...
@include('adminPanelWaiter.taTempProdTel.payMethodsScript')
@include('adminPanelWaiter.taTempProdTel.payCashModal')
@include('adminPanelWaiter.taTempProdTel.payRechnungModal')
...
<script>
    ...
    function checkInOpenProdNewTATemp(pId){
        $.ajax({
            url: '{{ route("dash.waiterCheckForCheckin") }}',
            method: 'post',
            data: {_token: '{{csrf_token()}}'},
    ...
    function addToCartExpressTATemp(taProId,notiAct){
        $.ajax({
            ...
            success: (checkCHINRespo) => {
                if($.trim(checkCHINRespo) == 'CheckInValide'){
                    $('#addToCartExpressBtn'+taProId).html('<img style="width:26px; height:auto;" src="storage/gifs/loading2.gif">');
                    if(notiAct == 1){
                        if(hasAddSoundSelected == 1){
                            $("#soundsAllNWP").html('<audio id="soundsAllNAPAudio" src="storage/sound/{{$usrNotiReg21Sound->soundTitle}}.{{$usrNotiReg21Sound->soundExt}}" autoplay="true"></audio>');
                        }else{
                    ...
                    $.ajax({
                        ...
                        success: () => {
                            ...
                            $('#addToCartExpressBtn'+taProId).html('<i class="fas fa-cart-plus" style="color: green;"></i>');
                        },
                        error: (error) => { console.log(error); }
                    });
                }else{
    ...
    function deleteTempTAProd(taTempProdId){
        $('#deleteTempTAProdBtn'+taTempProdId).html('<img style="width:26px; height:auto;" src="storage/gifs/loading2.gif">');
        $("#soundsAllNWP").html('<audio id="soundsAllNAPAudio" src="storage/sound/addOrCloseByStaf.mp3" autoplay="true"></audio>');
