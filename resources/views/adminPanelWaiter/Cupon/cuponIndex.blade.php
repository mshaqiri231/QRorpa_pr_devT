...
<section class="pl-2 pr-2 pt-4 pb-5" id="couponShow">
    ...
    <div id="addCuponBTNDIV">
        ...
        <button style="font-size:19px;" class="btn btn-block btnQrorpa shadow-none" data-toggle="modal" data-target="#addCuponModal" >
    ...
    <br>
        ...
        <div class="d-flex flex-wrap justify-content-between">
            ...
            <div class="d-flex flex-wrap p-2 mb-2" style="width: 24.5%; margin-right:0.5%; border:1px solid rgb(72,81,87); border-radius:15px;">
