                         ...
                         style="background-color: rgba(0, 0, 0, 0.5); padding-top:5%;">
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-footer d-flex justify-content-between">
                                    ...
                                    <button onclick="editTAProductTel('{{$takeAProd->id}}')" style="width:45%;" type="button" class="btn btn-block btn-outline-success" data-dismiss="modal">{{__('adminP.save')}}</button>
                                </div>
    ...
    <div class="d-flex justify-content-between mt-3" id="takeawayProdsElementTel">
        ...
        <div style="width:100%;">
            <div class="d-flex flex-wrap justify-content-between mb-1">
                ...
                <hr  style="width:100%;">
                <a href="{{route('admWoMng.adminWoTakeawaySortingWaiter')}}" style="width:49%;" class="btn btn-dark"><strong>{{__('adminP.productSorting')}}</strong></a>
                <button  style="width:49%;" class="btn btn-dark" data-toggle="modal" data-target="#addTAProdTATel"><strong>{{__('adminP.newSnack')}}</strong></button>
                <hr  style="width:100%;">
            </div>
                    ...
                    onclick="showProKatTel('.$kat->id.')">'?>
                        ...
                        <ul class="ProdLists" id="prodsOfTATel{{$kat->id}}" style="display:none;">
                            ...
                            @foreach (Takeaway::where([['kategoria', $kat->id],['prod_id',0]])->get() as $allPro )
                                    ...
                                    <li style="background-color:rgb(189, 246, 240)" id="ProdLiRight21Tel{{$theTA->id}}"> 
                                        <div class="d-flex justify-content-between" >
                                            <button style="width:7%;" data-toggle="modal" data-target="#removeTaProdConfirmationTel" onclick="PreRemoveTAProdTel('{{$kat->id}}','{{$theTA->id}}')" class="btn btn-outline-danger">X</button> 
                                            <span style="width:84%;" class="ml-3"> 
                                                <span>
                                                    {{number_format($allPro->qmimi, 2, '.', ' ')}}
                                                    @if($allPro->qmimi2 != 999999)
