...
<div class="p-3 pb-5">
    ...
    <div class="d-flex flex-wrap justify-content-between mt-2 mb-2">
        <h3 style="color:rgb(39,190,175); width:100%;"><strong>Sprich mit QRorpa</strong></h3>
        <button class="btn btn-outline-dark" style="width:100%;" data-toggle="modal" data-target="#addNewConvCard">
    ...
    <div id="myConvCarts" class="d-flex flex-wrap justify-content-start">
        ...
        @else
            ...
            <div class="card mb-2" style="width: 100%; background-color:rgb(39,190,175);">
                <div class="card-body p-1">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn shadow-none" style="padding:3px 5px 3px 5px; background-color:rgba(32,44,51,255);" type="button" onclick="sendMsg('{{$oneAv->id}}','{{Auth::User()->id}}')">
    ...
    <div id="convCartsForMe">
        <h4 style="color:rgb(72,81,87);"><strong>Gesprächskarten für Sie</strong></h4>
            ...
            <div class="card mb-2" style="width: 100%; background-color:rgb(39,190,175);">
                <div class="card-body p-1">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn shadow-none" style="padding:3px 5px 3px 5px; background-color:rgba(32,44,51,255);" type="button" onclick="sendMsg2('{{$oneAv->id}}','{{Auth::User()->id}}')">
                                <i style="color:white;" class="far fa-2x fa-arrow-alt-circle-right"></i>
                            </button>
                        </div>
                    </div>
