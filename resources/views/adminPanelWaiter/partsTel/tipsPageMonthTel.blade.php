            ...
            $resCreatedY = explode('-', $resCreated)[0];
             ...
             while(true){
                ...
                if($monthCount >= $resCreatedM && $yearCount >= $resCreatedY){
                    echo "
                        <div class='b-qrorpa color-white text-center p-2 m-2' style='border-radius:20px; width:45%; font-size:12px; font-weight:bold;'>
                            <a class='color-white anchorHover' href='adminWoTipsWaiter?mo=".$monthCount."&ye=".$yearCount."'>
                                ( ".$monthCount." )";
                                switch($monthCount){
