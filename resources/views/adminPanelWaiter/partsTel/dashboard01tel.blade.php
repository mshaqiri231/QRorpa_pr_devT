    ...
    <div>
        ...
        <div class="d-flex flex-wrap justify-content-between b-white p-1">
            ...
            @if (!isset($_GET['orSk']) || (isset($_GET['orSk']) && $_GET['orSk'] == 0))
                <button class="btn btn-dark mb-2" style="width:33%;"><strong>0-{{$firstMax}}</strong></button>
            @else
                @if(isset($_GET['mo']) && isset($_GET['ye']))
                <?php $mo=$_GET['mo']; $ye=$_GET['ye']; ?>
                <button onclick="location.href = 'admWoMngStatistics02Waiter?orSk=0&mo={{$mo}}&ye={{$ye}}';" class="btn btn-outline-dark mb-2" style="width:33%;"><strong>0-{{$firstMax}}</strong></button>
                @else
                <button onclick="location.href = 'admWoMngStatistics02Waiter?orSk=0';" class="btn btn-outline-dark mb-2" style="width:33%;"><strong>0-{{$firstMax}}</strong></button>
                @endif
            @endif
            ...
            @foreach (range(1, 8) as $nrRend) 
                ...
                @if ($OrderAllCount > $rngSt && $OrderAllCount >= $rngEd)
                    ...
                    @else
                        @if(isset($_GET['mo']) && isset($_GET['ye']))
                        <?php $mo=$_GET['mo']; $ye=$_GET['ye']; ?>
                        <button onclick="location.href = 'admWoMngStatistics02Waiter?orSk={{$rngSt}}&mo={{$mo}}&ye={{$ye}}';" class="btn btn-outline-dark shadow-none mb-2" style="width:33%;"><strong>{{$rngSt+1}}-{{$rngEd}}</strong></button>
                        @else
                        <button onclick="location.href = 'admWoMngStatistics02Waiter?orSk={{$rngSt}}';" class="btn btn-outline-dark shadow-none mb-2" style="width:33%;"><strong>{{$rngSt+1}}-{{$rngEd}}</strong></button>
                        @endif
                    @endif
                @elseif ($OrderAllCount > $rngSt)
                    ...
                    @else
                        @if(isset($_GET['mo']) && isset($_GET['ye']))
                        <?php $mo=$_GET['mo']; $ye=$_GET['ye']; ?>
                        <button onclick="location.href = 'admWoMngStatistics02Waiter?orSk={{$rngSt}}&mo={{$mo}}&ye={{$ye}}';" class="btn btn-outline-dark shadow-none mb-2" style="width:33%;"><strong>{{$rngSt+1}}-{{$OrderAllCount}}</strong></button>
                        @else
                        <button onclick="location.href = 'admWoMngStatistics02Waiter?orSk={{$rngSt}}';" class="btn btn-outline-dark shadow-none mb-2" style="width:33%;"><strong>{{$rngSt+1}}-{{$OrderAllCount}}</strong></button>
                        @endif
                    @endif
                @endif
            @endforeach
