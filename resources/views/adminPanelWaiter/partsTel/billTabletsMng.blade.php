...
<div style="padding: 5px 10px 40px 10px;">
    ...
    <div id="billTabletList" class="d-flex flex-wrap justify-content-start">
        ...
        @else
            <button style="width:100%; margin:0px; color:rgb(72,81,87);" class="btn btn-outline-dark shadow-none mb-1" data-toggle="modal" data-target="#RegBillTabletModal">
                <strong><i class="fa-solid fa-plus"></i>  Neues Rechnungs-Tablet RESTAURANT</strong>
            </button>
            @foreach ($allBillTRes as $oneBT)
                <div style="width:49.5%; margin:0 0.25% 7px 0.25%; border:1px solid rgb(72,81,87); border-radius:5px;" class="p-2 d-flex flex-wrap justify-content-between">
    ...
    <hr>
    <div id="billTabletListTa" style="width:100%;" class="d-flex flex-wrap justify-content-start">
        @if (count($allBillTTa) == 0)
            <p style="width: 100%; font-size:1.3rem; color:rgb(72,81,87);" class="text-center"><strong>Es sind noch keine Tablets für die Rechnungen registriert!</strong></p>
        @else
            <button style="width:100%; margin:0px; color:rgb(72,81,87);" class="btn btn-outline-dark shadow-none mb-1" data-toggle="modal" data-target="#RegBillTabletModalTA">
...
style="background-color: rgba(0, 0, 0, 0.5); padding-top:15%;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Registrieren Sie ein neues Tablet</h5>
