                            ...
                            <div>
                              @if(Auth::user()->role == 55)
                                ...
                                @if($usersAccessTel->where('accessDsc','Statistiken')->first() != NULL && $usersAccessTel->where('accessDsc','Statistiken')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.ordersStatisticsWaiter01')}}">
                                ...
                                @if($usersAccessTel->where('accessDsc','talkToQrorpaSA')->first() != NULL && $usersAccessTel->where('accessDsc','talkToQrorpaSA')->first()->accessValid == 1)
                                  @if($newMsgForMeTel > 0)
                                    <a class="optionsAnchorPh button-glow-red" style="color:red !important;" href="{{route('admWoMng.adminSaMsgWaiter')}}">
                                      <i class="far fa-comments"></i>  {{__('adminP.talkToQRorpa')}}      
                                    </a>
                                  @else
                                    <a class="optionsAnchorPh" href="{{route('admWoMng.adminSaMsgWaiter')}}">
                                      <i class="far fa-comments"></i>  {{__('adminP.talkToQRorpa')}}      
                                    </a>
                                  @endif
                                @endif
                                ...
                                <a class="optionsAnchorPh" href="{{route('waiter.notificationsActPage')}}">
                                ...
                                @if($usersAccessTel->where('accessDsc','Aufträge')->first() != NULL && $usersAccessTel->where('accessDsc','Aufträge')->first()->accessValid == 1)
                                  ...
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.indexAdmMngPageWaiter')}}">
                                  ...
                                  <div id="showModalServiceTel">
                                    ...
                                    @if($usersAccessTel->where('accessDsc','Takeaway')->first() != NULL && $usersAccessTel->where('accessDsc','Takeaway')->first()->accessValid == 1)
                                      ...
                                      <a class="optionsAnchorPh button-glow-red" style="color:red !important;" onclick="location.href = '/admWoMngTakeawayWaiter';">
                                        <i class="fas fa-border-all"></i> {{__('adminP.takeawayOrders')}}
                                      </a>
                                      @else
                                      <a class="optionsAnchorPh" onclick="location.href = '/admWoMngTakeawayWaiter';">
                                        <i class="fas fa-border-all"></i> {{__('adminP.takeawayOrders')}}
                                      </a>
                                      @endif
                                    @endif
                                    ...
                                    @if($usersAccessTel->where('accessDsc','Delivery')->first() != NULL && $usersAccessTel->where('accessDsc','Delivery')->first()->accessValid == 1)
                                      ...
                                      <a class="optionsAnchorPh button-glow-red" style="color:red !important;"  onclick="location.href = '/admWoMngDeliveryWaiter';">
                                        <i class="fas fa-border-all"></i> {{__('adminP.deliveryOrders')}}
                                      </a>
                                      @else
                                      <a class="optionsAnchorPh" onclick="location.href = '/admWoMngDeliveryWaiter';">
                                        <i class="fas fa-border-all"></i> {{__('adminP.deliveryOrders')}}
                                      </a>
                                      @endif
                                    @endif
                                  ...
                                  <a class="optionsAnchorPh" href="{{route('giftCardWa.giftCardMngAdminWa')}}">
                                    <i class="fa-regular fa-credit-card"></i> Geschenkkarte 
                                  </a>

                                  @if($usersAccessTel->where('accessDsc','Tabellenstatus_Tische')->first() != NULL && $usersAccessTel->where('accessDsc','Tabellenstatus_Tische')->first()->accessValid == 1)
                                    <a class="optionsAnchorPh" href="{{route('admWoMng.ordersFreeTablesAdmMngPageWaiter')}}">
                                ...
                                @if($usersAccessTel->where('accessDsc','Empfohlen')->first() != NULL && $usersAccessTel->where('accessDsc','Empfohlen')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoRecomendetProdWaiter')}}">
                                    <i class="fas fa-band-aid"></i>  {{__('adminP.suggestedProducts')}}
                                  </a>
                                @endif

                                @if($usersAccessTel->where('accessDsc','Kellner')->first() != NULL && $usersAccessTel->where('accessDsc','Kellner')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoWaiterCallsWaiter')}}">
                                    <i class="fas fa-user-edit"></i> Kellner ruft
                                  </a>
                                @endif

                                @if($usersAccessTel->where('accessDsc','Products')->first() != NULL && $usersAccessTel->where('accessDsc','Products')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoContentMngWaiter')}}">
                                    <i class="fas fa-sitemap"></i> {{__('adminP.products')}}
                                  </a>
                                @endif

                                @if(1 == 1)
                                  <a class="optionsAnchorPh" href="{{route('orServing.orderServingDevicesPageWaiter')}}">
                                ...
                                @if($usersAccessTel->where('accessDsc','Tabellenwechsel')->first() != NULL && $usersAccessTel->where('accessDsc','Tabellenwechsel')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoTableChngReqWaiter')}}">
                                ...
                                @if($usersAccessTel->where('accessDsc','Trinkgeld')->first() != NULL && $usersAccessTel->where('accessDsc','Trinkgeld')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoTipsWaiter')}}">
                                ...
                                @if($usersAccessTel->where('accessDsc','16+/18+')->first() != NULL && $usersAccessTel->where('accessDsc','16+/18+')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoRestrictProductsWaiter')}}">
                                ...
                                @if($usersAccessTel->where('accessDsc','Gutscheincode')->first() != NULL && $usersAccessTel->where('accessDsc','Gutscheincode')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoCouponsWaiter')}}">
                                    <i class="fas fa-ticket-alt"></i>  {{__('adminP.couponCode')}}
                                  </a>
                                @endif

                                @if($usersAccessTel->where('accessDsc','Takeaway')->first() != NULL && $usersAccessTel->where('accessDsc','Takeaway')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoTakeawayWaiter')}}">
                                    <i class="fas fa-hotdog"></i>  {{__('adminP.takeaway')}}
                                  </a>
                                @endif
                                
                                @if($usersAccessTel->where('accessDsc','Delivery')->first() != NULL && $usersAccessTel->where('accessDsc','Delivery')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoDeliveryWaiter')}}">
                                ...
                                @if($usersAccessTel->where('accessDsc','Tischkapazität')->first() != NULL && $usersAccessTel->where('accessDsc','Tischkapazität')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoTableCapacityWaiter')}}">
                                    <i class="fas fa-user-check"></i> {{__('adminP.tableCapacity')}}
                                  </a>
                                @endif

                                <a class="optionsAnchorPh" href="{{route('billTabletWaiter.index')}}">
                                ...
                                @if($usersAccessTel->where('accessDsc','Tischreservierungen')->first() != NULL && $usersAccessTel->where('accessDsc','Tischreservierungen')->first()->accessValid == 1)
                                  <?php
                                    $newRezRequestsTel = TableReservation::where([['toRes', Auth::user()->sFor],['tableNr', 999999],['status',0]])->whereDate('dita', '>=', Carbon::today())->whereIn('tableNr',$myTablesWaiter)->count();
                                  ?>  
                                  @if($newRezRequestsTel > 0)
                                    <a class="optionsAnchorPh button-glow-red" style="color:red !important;" href="{{route('admWoMng.adminWoTableReservationIndexWaiter')}}">
                                      <i class="fas fa-receipt"></i>  {{__('adminP.tableReservations')}}
                                    </a>
                                  @else
                                    <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoTableReservationIndexWaiter')}}">
                                      <i class="fas fa-receipt"></i>  {{__('adminP.tableReservations')}}
                                    </a>
                                  @endif
                                @endif
                                ...
                                @if($usersAccessTel->where('accessDsc','Dienstleistungen')->first() != NULL && $usersAccessTel->where('accessDsc','Dienstleistungen')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoServiceRequestWaiter')}}">
                                ...
                                @if($usersAccessTel->where('accessDsc','Covid-19')->first() != NULL && $usersAccessTel->where('accessDsc','Covid-19')->first()->accessValid == 1)
                                  <a class="optionsAnchorPh" href="{{route('admWoMng.adminWoCovid19Waiter')}}">
