...
<div class="mt-2 mb-4" id="gcDiv">
    ...
    <div class="d-flex flex-wrap justify-content-between">
        <p style="width:45%; font-size:1.5rem; color:rgb(39,190,175); margin:0px;" class="pl-2"><strong>Geschenkkarte</strong></p>
        ...
        <button style="width:19.8%;" class="btn btn-info shadow-none" data-toggle="modal" data-target="#deletedGCModal" onclick="showDeletedGC()">
            <strong><i class="fa-regular fa-rectangle-list"></i>Gelöscht GK</strong>
        </button>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-wrap justify-content-between" id="addSellAGCModalBody">
                ...
                <div style="width: 50%;" onchange="removeYearsSelected()" class="form-group d-flex justify-content-between">
                    <input style="width: 88%;" class="form-control shadow-none" type="date" id="pickExpirationDate01" name="pickExpirationDate01" />
                ...
                <div class="modal-body d-flex flex-wrap justify-content-between" style="width:100%;" id="addSellAGCModalBodySubPart3">
                    ...
                    <button id="payGCBtn3" style="width:24.5%; margin:0px;" class="btn btn-warning text-center shadow-none" disabled>
...
@include('adminPanelWaiter.giftCard.gcModals')
@include('adminPanelWaiter.giftCard.gcScript')