...
<section class="pl-2 pr-2 pb-5">
    <h4 style="color:rgb(39,195,175);" class="p-2"><strong>Ihre Berichte für den täglichen Umsatz</strong></h4>
    ...
    <div id="waTodaySalesP1">
        @if(waiterDaySales::where('forWa',Auth::user()->id)->whereDate('forDay',$dateCheckCreate)->first() == Null)
            <h5 style="color:rgb(39,195,175);" class="p-2"><strong>Registrieren Sie den heutigen Verkaufsbericht</strong></h5>
            ...
            <div class="d-flex justify-content-start flex-wrap mt-2">
                ...
                <div id="calSalesDiv" style="display:flex; width:100%;" class=" justify-content-start flex-wrap">
                    <div style="width:13.5%; margin-right:0.78%;" class="input-group mb-1">
                    ...
                    <div style="width:16%; margin-right:0.66%;" class="input-group mb-1">
                        <div class="input-group-prepend">
                            <span class="input-group-text">#</span>
                        </div>
                    ...
                    <div style="width:32%; margin-right:2%;" class="input-group mt-3">
                        <div class="input-group-prepend">
                            <span style="font-size:1.4rem;" class="input-group-text"><strong>Anzahl Münzen</strong></span>
                        </div>
                        <input style="font-weight: bold; font-size:1.4rem;" type="number" step="1" id="nrOfCoinsTotal" class="form-control shadow-none" value="0" disabled>
                    </div>
                    <div style="width:32%; margin-right:2%;" class="input-group mt-3">
                        <div class="input-group-prepend">
                            <span style="font-size:1.4rem;" class="input-group-text"><strong>Anzahl Banknoten</strong></span>
                        </div>
                        <input style="font-weight: bold; font-size:1.4rem;" type="number" step="1" id="nrOfBanknotesTotal" class="form-control shadow-none" value="0" disabled>
                    </div>
                    <div style="width:32%;" class="input-group mt-3">
                        <div class="input-group-prepend">
                            <span style="font-size:1.4rem;" class="input-group-text"><strong>Total in CHF</strong></span>
                        </div>
                        <input style="font-weight: bold; font-size:1.4rem;" type="number" step="1" id="totalInChf" class="form-control shadow-none" value="0" disabled>
                    </div>
                ...
                <div style="width:24.5%; margin-right:0.5%;" class="input-group mb-1">
                    <div class="input-group-prepend">
        ...
        @else
            <div class="alert alert-success p-1 mt-1 text-center" style="font-size: 1.4rem;">
                            ...
                            @for($i=1;$i<=$month->daysInMonth;$i++)
                                ...
                                @if($i == 1)
                                    ...
                                    @if($dateCheckCreate >= Auth::user()->created_at && $dateCheckCreate <= Carbon::now())
                                        ...
                                        style="width:14.1%; margin-right:0.18%;" data-toggle="modal" data-target="#salesRepModal" onclick="openRepSale('{{$dateCheckCreate}}')">
                                            <strong>{{$i}}</strong>
                                        </button>
                                    @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    ...
                    <table class="table table-bordered" id="salesRepModalTbl2">
                        <tbody>
                            <tr>
                                <td><strong><span class="ml-1 mr-1" style="font-size: 1.2rem;">Bar</span></strong></td>
                                <td><strong><span class="ml-1 mr-1" style="font-size: 1.2rem;" id="showCashDirect">-</span>CHF</strong></td>
                            </tr>
                            <tr>
                                <td><strong><span class="ml-1 mr-1" style="font-size: 1.2rem;">POS/Karte</span></strong></td>
                                <td><strong><span class="ml-1 mr-1" style="font-size: 1.2rem;" id="showCardDirect">-</span>CHF</strong></td>
                            </tr>
                            <tr>
                                <td><strong><span class="ml-1 mr-1" style="font-size: 1.2rem;">Online</span></strong></td>
                                <td><strong><span class="ml-1 mr-1" style="font-size: 1.2rem;" id="showOnlineDirect">-</span>CHF</strong></td>
                            </tr>
                            <tr>
                                <td><strong><span class="ml-1 mr-1" style="font-size: 1.2rem;">Auf Rechnung</span></strong></td>
                                <td><strong><span class="ml-1 mr-1" style="font-size: 1.2rem;" id="showRechnungDirect">-</span>CHF</strong></td>
                            </tr>
                            <tr>
                                <td colspan="4" class="text-center" style="font-size: 1.4rem;"><strong> Gesamtumsatz : <span class="ml-1 mr-1" id="totalInCHF2">-</span> CHF</strong></td>
                            </tr>
                        </tbody>
