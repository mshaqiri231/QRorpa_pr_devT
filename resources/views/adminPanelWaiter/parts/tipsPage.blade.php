...
<section class="p-3 pb-5">
    <?php
        ...
        if(isset($_GET['mo'])){
            ...
            foreach(TipLog::where('toRes','=', $thisRestaurantId)->whereDate('created_at', $_GET['mo'])->get()->sortByDesc('created_at') as $allTips){
    ...
    <div class="d-flex justify-content-between mb-2">
        ...
        @endif
        <a href="{{route('admWoMng.adminWoTipsMonthWaiter')}}" class="b-qrorpa color-white text-center p-2 anchorHover" style="border-radius:20px; width:49.5%; font-size:19px; font-weight:bold;">
