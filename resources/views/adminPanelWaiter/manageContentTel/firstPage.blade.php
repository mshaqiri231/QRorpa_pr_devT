...
<div  class="d-flex flex-wrap justify-content-between pl-2 pr-2">
    <a href="{{route('admWoMng.adminWoContentMngOrderWaiter')}}" style="width:100%;  background-color:rgb(39,190,175); border-radius:15px; color:white; font-size:17px;" class="btn p-2">
...
<div id="showMenuTel">
    @include('adminPanelWaiter.manageContentTel.showMenu')
</div>

<div id="modalsDivTel">
 @include('adminPanelWaiter.manageContentTel.addModals')
 @include('adminPanelWaiter.manageContentTel.editModals')
 @include('adminPanelWaiter.manageContentTel.addETModals')
</div>
