                                    ...
                                    <div class="row">
                                        ...
                                        <di class="col-9">
                                            ...
                                            <div class="col-3 add-plus-section">
                                                ...
                                                <button class="btn-block btn btn-outline-primary shadow-none" data-toggle="modal" data-target="#editProduktModal{{$ketoProd->id}}Tel">{{__('adminP.toEdit')}}</button>
                                                <button class="btn-block btn btn-outline-danger shadow-none" data-toggle="modal" data-target="#deleteProductConfirm{{$ketoProd->id}}Tel">{{__('adminP.extinguish')}}</button>
                                            </div>
