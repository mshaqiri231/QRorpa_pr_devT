    ...
    <div style="width:100%;" class="d-flex flex-wrap justify-content-start mt-3" id="showDevicesDiv">
        ...
        @else
            @foreach ($allOrDevices as $oneOrDevices)
                <div style="width:100%; margin:4px 0% 4px 0%; border:1px solid rgb(72,81,87); border-radius:7px;" class="d-flex flex-wrap justify-content-between p-1" id="showDevicesDivOne{{$oneOrDevices->id}}">
...
@include('adminPanelWaiter.orderServingDevicesTel.indexJS')