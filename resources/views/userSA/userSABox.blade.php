...
<section class="d-flex" >
    ...
    <div class="p-4" style="width:80%; border-bottom-left-radius:30px; border-bottom-right-radius:30px; background-color:white;">
        ...
        <div class="container-fluid mb-4 " >
            <div class="row mt-4">
                <a href="{{route('homeConRegUser')}}" class="col-2 anchorMy pt-4" style="font-size:25px;"><strong> < Back </strong></a>
        ...
        <div class="container mb-4 ">
            <div class="row">
                <div class="col-12 d-flex flex-wrap justify-content-between">
                    ...
                    <a style="width:49%;" href="{{route('homeConRegUserCat',['Res' => $_GET['Res']])}}">
                        <div style="background-color:rgb(39,190,175); border-radius:15px; color:white;" class="p-3 text-center mb-2">
                            <h2>Category ( {{kategori::where('toRes',$_GET['Res'])->count()}} )</h2>
                        </div>
                    </a>

                    <a style="width:49%;" href="{{route('homeConRegUserProduct',['Res' => $_GET['Res']])}}">
                        <div style="background-color:rgb(39,190,175); border-radius:15px; color:white;" class="p-3 text-center mb-2">
                            <h2>Products ( {{Produktet::where('toRes',$_GET['Res'])->count()}} )</h2>
                        </div>
                    </a>

                    <a style="width:49%;" href="{{route('homeConRegUserExtra',['Res' => $_GET['Res']])}}">
                        <div style="background-color:rgb(39,190,175); border-radius:15px; color:white;" class="p-3 text-center mb-2">
                            <h2>Extra ( {{ekstra::where('toRes',$_GET['Res'])->count()}} )</h2>
                        </div>
                    </a>

                    <a style="width:49%;" href="{{route('homeConRegUserType',['Res' => $_GET['Res']])}}">
                        <div style="background-color:rgb(39,190,175); border-radius:15px; color:white;" class="p-3 text-center mb-2">
                            <h2>Types ( {{LlojetPro::where('toRes',$_GET['Res'])->count()}} )</h2>
                        </div>
                    </a>


                    <a style="width:100%;" href="{{route('homeConRegUserTable',['Res' => $_GET['Res']])}}" class="mt-3">
                        <div style="background-color:rgb(39,190,175); border-radius:15px; color:white;" class="p-3 text-center mb-2">
                            <h2>Tables / QR codes ( {{TableQrcode::where('Restaurant', $_GET['Res'])->count()}} )</h2>
                        </div>
                    </a>
        ...
        <hr>
        <div class="d-flex">
            <h2 style="width:100%;" class="color-qrorpa pb-2 pr-3 text-center"><strong>Arbeitszeiten im Restaurant</strong></h2>
        ...
        @endif
        <button class="btn btn-outline-dark mb-4" style="width:100%;"  data-toggle="modal" data-target="#resDescModal">Set description</button>


                    <!-- restorant Description Modal-->
                            ...
                            {{Form::open(['action' => 'RestorantController@setDesc', 'method' => 'post' ]) }}
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('desc','', ['class' => 'form-control', 'rows'=>'3', 'required']) }}
                                    </div>
                                </div>
                                {{ Form::hidden('res', $_GET['Res'] , ['id' => 'restaurant']) }}
                                {{ Form::hidden('userSA', '1' , ['id' => 'restaurant']) }}
                                <!-- Modal footer -->
