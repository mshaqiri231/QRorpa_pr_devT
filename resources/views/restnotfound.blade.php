...
<html lang="de" translate="no">
    ...
    <body>
        ...
        <div class="text-center pr-3 pl-3">
            <p style="width:100%;" class="text-center"><strong>Das gesuchte Restaurant oder der gesuchte Tisch ist nicht registriert</strong></p>
            <a href="{{ route('firstPage.index') }}" class="btn btn-dark btn-block">
                QRorpa Home Page 
            </a>
        </div>
