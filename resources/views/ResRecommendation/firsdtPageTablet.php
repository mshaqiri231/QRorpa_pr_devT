...
<html lang="en">
    <head>
        ...
        <style>
            ...
            @media screen and (min-width: 100px) and (max-width : 915px){
                #element1{ font-size:0.9cm ;}
                #element2{ font-size:0.8cm ;}
                #element3{ font-size:0.5cm ;}
                #element4{ font-size:1.1cm ;}
                #element5{ font-size:1.1cm ;}
                #element6{ margin-top: -0.2cm;}
            }
            @media screen and (min-width: 916px) and (max-width : 1304px){
                #element1{ font-size:1.2cm ;}
                #element2{ font-size:1.1cm ;}
                #element3{ font-size:0.7cm ;}
                #element4{ font-size:1.5cm ;}
                #element5{ font-size:1.5cm ;}
                #element6{ margin-top: -1cm;}
            }
    ...
    <body>
        <div style="width:100%; padding:1cm 0px 1cm 0px; background-image: linear-gradient(to top right, rgb(39,190,175) ,rgba(9,40,79,255));">
            <div class="container">
                <div class="d-flex">
                    <div style="width: 50%;"> 
                        <img src="storage/images/logo_QRorpa_1024_512.png" style="width: 6cm; height:auto; margin-bottom:0.5cm;" alt="">
                        <p id="element1" style="color: white; font-weight:bold; white-space: wrap;">Empfehlen und bis zu CHF 1000.- erhalten!</p>
                        <p id="element2" style="color: white; font-weight:bold; white-space: wrap; margin:0px;">QRorpa Kassensysteme</p>
                        <p id="element3" style="color: white; font-weight:bold; white-space: wrap;">kontaktlos bestellen & bezahlen</p>
                    </div>
                    <div style="width: 50%;">
                        <img src="storage/ResRecommendation/Design ohne Titel-min2.png" style="width: 100%; height:auto;" alt="">
                    </div>
                </div>
                <div id="element6" class="flex justify-content-between">
        ...
        <div style="width:100%; padding:2cm 0px 1cm 0px; background-image: linear-gradient(to top, rgb(39,190,175) ,rgba(9,40,79,255));">
            <div class="container">
                <div class="d-flex flex-wrap justify-content-between">
                    <div style="width: 47%;"> 
                        <p id="element4" style="color:white; background-color:rgba(7,19,50,255); padding:0.9cm;" class="text-center mb-2">Kontaktperson</p>
                    ...
                    <div style="width: 47%;"> 
                        <p  id="element5" style="color:white; background-color:rgba(7,19,50,255); padding:0.9cm;" class="text-center mb-2">Betrieb</p>
