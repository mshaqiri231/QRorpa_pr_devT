...
<html lang="en">
    ...
    <body>
        <div style="width:100%; padding:0.3cm 0px 0.3cm 0px; background-image: linear-gradient(to top right, rgb(39,190,175) ,rgba(9,40,79,255));">
         
                <div class="d-flex flex-wrap">
                    <div style="width: 100%;" class="flexFont"> 
                        <img src="storage/images/logo_QRorpa_1024_512.png" style="width: 60%; height:auto; margin-bottom:0.2cm; margin-left:20%;" alt="">
                        <p class="text-center" style="color: white; font-size:0.85cm; font-weight:bold; white-space: wrap;">Empfehlen und bis zu</p>
                        <p class="text-center" style="color: white; font-size:0.85cm; font-weight:bold; white-space: wrap;">CHF 1000.- erhalten!</p>
                        <p class="text-center" style="color: white; font-size:0.8cm; font-weight:bold; white-space: wrap; margin:0px;">QRorpa Kassensysteme</p>
                        <p class="text-center" style="color: white; font-size:0.6cm; font-weight:bold; white-space: wrap;">kontaktlos bestellen & bezahlen</p>
                    </div>
                    <div style="width: 100%;">
                ...
                <div class="d-flex flex-wrap justify-content-between">
                    <img src="storage/ResRecommendation/qrIc_7.png" style="width: 33%; height:auto;" alt="">
                    <img src="storage/ResRecommendation/qrIc_01.png" style="width:33%; height:auto;" alt="">
                    <img src="storage/ResRecommendation/qrIc_2.png" style="width: 33%; height:auto;" alt="">
                    <img src="storage/ResRecommendation/qrIc_3.png" style="width: 33%; height:auto;" alt="">
                    <img src="storage/ResRecommendation/qrIc_4.png" style="width: 33%; height:auto;" alt="">
                    <img src="storage/ResRecommendation/qrIc_5.png" style="width: 33%; height:auto;" alt="">
                    <img src="storage/ResRecommendation/qrIc_6.png" style="width: 33%; height:auto;" alt="">
                    <img src="storage/ResRecommendation/qrIc_9.png" style="width: 33%; height:auto;" alt="">
                    <img src="storage/ResRecommendation/qrIc_8.png" style="width: 33%; height:auto;" alt="">
                </div>
           
        </div>
        <div style="width:100%; padding:0.3cm 0px 0.3cm 0px; background-image: linear-gradient(to top, rgb(39,190,175) ,rgba(9,40,79,255));">
            
                <div class="d-flex flex-wrap justify-content-between">
                    <div style="width: 90%; margin-left:5%;"> 
                        <p style="font-size:1cm; color:white; background-color:rgba(7,19,50,255); padding:0.7cm;" class="text-center mb-2">Kontaktperson</p>
                    ...
                    <div style="width: 90%; margin-left:5%;"> 
                        <p style="font-size:1cm; color:white; background-color:rgba(7,19,50,255); padding:0.7cm;" class="text-center mb-2">Betrieb</p>
                    ...
                    <div class="form-check" style="width: 90%; margin-left:5%;">
                        <input type="checkbox" class="form-check-input" id="dataPrChBox01" style="width:22px; height:22px;">
                        <label class="form-check-label pl-2" for="dataPrChBox01" style="font-size:16px; color:white;">Ich habe die Datenschutzbestimmungen zur Kenntnis genommen*</label>
                    </div>
                    <button style="color:white; background-color:rgba(7,19,50,255); padding:0.2cm; border-radius:4px; width:90%; margin-left:5%; font-size:1cm;" id="saveResRecKontBtn"
                    ...
                    <div class="aler alert-success text-center mt-1 p-2" style="display:none; width:100%; font-size:1.2rem;" id="succMsg01">
                        <strong>Sie haben diese Empfehlung erfolgreich registriert, wir werden Sie mit weiteren Informationen kontaktieren</strong>
                    </div>

                    <div class="d-flex flex-wrap justify-content-between mt-4" style="width: 100%; padding:0.4cm; background-color:rgba(87,228,255,255);">
                        <p style="margin:0px; font-size:1.6rem; color:rgb(72,81,87); width:100%;" class="text-center"><strong>Social</strong></p>
