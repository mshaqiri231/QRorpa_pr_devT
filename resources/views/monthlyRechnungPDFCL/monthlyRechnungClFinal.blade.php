...
use App\rechnungClient;
    ...
    $pdfname = public_path().'/storage/rechnungMonthlyFirst/'.$theRes->emri.'_'.$theClient->id.'_PreRechnung_'.$billMonthSnd.'_'.$billYearSnd.'.pdf';
...
<body id="pageCounter">
    ...
    <footer id="footerPC">
        <p style="width: 100%; text-align:right; "> <span class="pageNumbers"></span>{{$pages}}</p>
    </footer>
