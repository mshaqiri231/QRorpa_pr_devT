...
<html lang="de" translate="no">
    ...
    <body>
        <div class="main flex-wrap" > 
            <img src="storage/images/logo_QRorpa.png" style="width: 250px; height:auto; margin-bottom:-100px; z-index:10;" alt="logo">
        ...
        <div class="text-center pr-3 pl-3" style="margin-top:-80px;">
            <p style="width:100%; font-size:1.2rem; color:rgb(39,190,175);" class="text-center">
                <strong>Wir haben festgestellt, dass Sie keinen Zugriff auf diesen Service haben. Bitte kontaktieren Sie den Restaurantadministrator oder QRorpa für weitere Informationen</strong>
            </p>
            <a class="optionsAnchorPh btn btn-outline-danger shadow-none" style="font-size:1.3rem;" href="{{ route('logout') }}"
        ...
        <div class="d-flex flex-wrap justify-content-between">
            @foreach (accessControllForAdmins::where('userId',Auth::user()->id)->get() as $acsOne)
                @switch($acsOne->accessDsc)
                    @case('Statistiken')
                        <a href="{{route('dash.statistics')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.statistics')}}</strong>
                        </a>
                    @break
                    @case('Aufträge')
                        <a href="{{route('dash.index')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.assignments')}}</strong>
                        </a>
                    @break
                    @case('Dienstleistungen')
                        <a href="{{route('SerReqCli.APindex')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.services')}}</strong>
                        </a>
                    @break
                    @case('Empfohlen')
                        <a href="{{route('dash.recom')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.recommended')}}</strong>
                        </a>
                    @break
                    @case('RechnungMngAcce')
                        <a href="{{route('dash.rechnungPage')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.RechnungSidePg')}}</strong>
                        </a>
                    @break
                    @case('Tabellenwechsel')
                        <a href="{{route('TabChngCli.indexAP')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.changeTable')}}</strong>
                        </a>
                    @break
                    @case('Trinkgeld')
                        <a href="{{route('tips.index')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.tip')}}</strong>
                        </a>
                    @break
                    @case('Tischreservierungen')
                        <a href="{{route('TableReservation.ADIndex')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.tableReservations')}}</strong>
                        </a>
                    @break
                    @case('Products')
                        <a href="{{route('dash.indexConMng')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.products')}}</strong>
                        </a>
                    @break
                    @case('Frei')
                        <a href="{{route('freeProd.index')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.free')}}</strong>
                        </a>
                    @break
                    @case('workersManagement')
                        <a href="{{route('admWoMng.indexAdmMngPage')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.workers')}}</strong>
                        </a>
                    @break
                    @case('16+/18+')
                        <a href="{{route('restrictProd.index')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>16+/18+</strong>
                        </a>
                    @break
                    @case('Gutscheincode')
                        <a href="{{route('cupons.index')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.couponCode')}}</strong>
                        </a>
                    @break
                    @case('Takeaway')
                        <a href="{{route('takeaway.index')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.takeaway')}}</strong>
                        </a>
                    @break
                    @case('Delivery')
                        <a href="{{route('delivery.index')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.delivery')}}</strong>
                        </a>
                    @break
                    @case('Tischkapazität')
                        <a href="{{route('table.capacity')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.tableCapacity')}}</strong>
                        </a>
                    @break
                    @case('talkToQrorpaSA')
                        <a href="{{route('atsMsg.openPageAdminPanel')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.talkToQRorpa')}}</strong>
                        </a>
                    @break
                    @case('Covid-19')
                        <a href="{{route('covidsAdmin.indexAdmin')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
        ...
        @elseif(Auth::check() && Auth::user()->role == 55)
        <div class="d-flex flex-wrap justify-content-between">
            @foreach (accessControllForAdmins::where('userId',Auth::user()->id)->get() as $acsOne)
                @switch($acsOne->accessDsc)
                    @case('Statistiken')
                        <a href="{{route('admWoMng.ordersStatisticsWaiter01')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.statistics')}}</strong>
                        </a>
                    @break
                    @case('Heute_Verkaufe')
                        <a href="{{route('waSalesToday.waSalesTodayPage')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>heutige Verkäufe</strong>
                        </a>
                    @break
                    @case('Dienstleistungen')
                        <a href="{{route('admWoMng.adminWoServiceRequestWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.services')}}</strong>
                        </a>
                    @break
                    @case('Aufträge')
                        <a href="{{route('admWoMng.indexAdmMngPageWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.assignments')}}</strong>
                        </a>
                    @break
                    @case('Empfohlen')
                        <a href="{{route('admWoMng.adminWoRecomendetProdWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.recommended')}}</strong>
                        </a>
                    @break
                    @case('RechnungMngAcce')
                        <a href="{{route('admWoMng.adminWoRechnungPageWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.RechnungSidePg')}}</strong>
                        </a>
                    @break
                    @case('Tabellenwechsel')
                        <a href="{{route('admWoMng.adminWoTableChngReqWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.changeTable')}}</strong>
                        </a>
                    @break
                    @case('Trinkgeld')
                        <a href="{{route('admWoMng.adminWoTipsWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.tip')}}</strong>
                        </a>
                    @break
                    @case('Tischreservierungen')
                        <a href="{{route('admWoMng.adminWoTableReservationIndexWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.tableReservations')}}</strong>
                        </a>
                    @break
                    @case('Products')
                        <a href="{{route('admWoMng.adminWoContentMngWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.products')}}</strong>
                        </a>
                    @break
                    @case('Frei')
                        <a href="{{route('admWoMng.adminWoFreeProductsWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.free')}}</strong>
                        </a>
                    @break
                    @case('16+/18+')
                        <a href="{{route('admWoMng.adminWoRestrictProductsWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>16+/18+</strong>
                        </a>
                    @break
                    @case('Gutscheincode')
                        <a href="{{route('admWoMng.adminWoCouponsWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.couponCode')}}</strong>
                        </a>
                    @break
                    @case('Takeaway')
                        <a href="{{route('admWoMng.adminWoTakeawayWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.takeaway')}}</strong>
                        </a>
                    @break
                    @case('Delivery')
                        <a href="{{route('admWoMng.adminWoDeliveryWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.delivery')}}</strong>
                        </a>
                    @break
                    @case('Tischkapazität')
                        <a href="{{route('admWoMng.adminWoTableCapacityWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.tableCapacity')}}</strong>
                        </a>
                    @break
                    @case('talkToQrorpaSA')
                        <a href="{{route('admWoMng.adminSaMsgWaiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.talkToQRorpa')}}</strong>
                        </a>
                    @break
                    @case('Covid-19')
                        <a href="{{route('admWoMng.adminWoCovid19Waiter')}}" style="width:fit-content;" class="btn btn-outline-dark shadow-none">
                            <strong>{{__('adminP.Covid-19')}}</strong>
                        </a>
                    @break
