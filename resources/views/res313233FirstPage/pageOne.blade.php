...
<body>
    ...
    @include('res313233FirstPage.appRes313232FP')
    <div class="layer" style="z-index:1; height:100%;">
        <div class="text-center  d-flex flex-wrap justify-content-around" style="padding-top:2.5cm; z-index:1; ">
            ...
            <div class="resCard d-flex flex-wrap justify-content-between mt-3">
                ...
                <button class="btn btn-dark shadow-none" style="width:49.5%; margin:0px;" data-bs-toggle="modal" data-bs-target="#res31ResMenuModal">
                    <strong><i class="fa-solid fa-book-open-reader"></i></strong>
                </button>
                <button class="btn btn-dark shadow-none" style="width:49.5%; margin:0px;" data-bs-toggle="modal" data-bs-target="#res31ResTablesModal" >
                    Tisch
                </button>
            </div>
            ...
            <div class="resCard d-flex flex-wrap justify-content-between mt-3">
                ...
                <button class="btn btn-dark shadow-none" style="width:49.5%; margin:0px;" data-bs-toggle="modal" data-bs-target="#res31TaMenuModal">
                    <strong><i class="fa-solid fa-book-open-reader"></i></strong>
                </button>
                <a class="btn btn-dark shadow-none" style="width:49.5%; margin:0px;"  href="https://qrorpa.ch/?Res=31&t=500">
                    Bestellen
                </a>
            </div>
            ...
            <div class="resCard d-flex flex-wrap justify-content-between mt-3">
                ...
                <button class="btn btn-dark shadow-none" style="width:49.5%; margin:0px;" data-bs-toggle="modal" data-bs-target="#res32TaMenuModal">
                    <strong><i class="fa-solid fa-book-open-reader"></i></strong>
                </button>
                <a class="btn btn-dark shadow-none" style="width:49.5%; margin:0px;" href="https://qrorpa.ch/?Res=32&t=500">
                    Bestellen
                </a>
            </div>
            ...
            <div class="resCard d-flex flex-wrap justify-content-between mt-3">
                ...
                <button class="btn btn-dark shadow-none" style="width:49.5%; margin:0px;" data-bs-toggle="modal" data-bs-target="#res33TaMenuModal">
                    <strong><i class="fa-solid fa-book-open-reader"></i></strong>
                </button>
                <a class="btn btn-dark shadow-none" style="width:49.5%; margin:0px;" href="https://qrorpa.ch/?Res=33&t=500">
                    Bestellen
                </a>
            </div>
    ...
    <!-- Restaurant 31 Tables -->
    <div class="modal fade" id="res31ResTablesModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body d-flex flex-wrap justify-content-start">
                    ...
                    @foreach (TableQrcode::where('Restaurant','31')->orderBy('tableNr')->get() as $tbl )
                        @if ($tbl->kaTab == 0)
                        <div class="mb-1" style="width:19.5%; margin-right:0.5%; border:1px solid rgb(39,190,175); border-radius:7px; background-color:rgb(39,190,175);">
                        @else
                        <div class="mb-1" style="width:19.5%; margin-right:0.5%; border:1px solid rgb(220, 20, 60); border-radius:7px; background-color:rgb(220, 20, 60)"> 
    ...
    <!-- Restaurant 31 Menu -->
    <div class="modal fade" id="res31ResMenuModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><strong>Sport Restaurant Obere Au<br> "Restaurant"</strong></h5>
                ...
                <div class="modal-body">
                    @foreach (Produktet::where([['toRes','31'],['accessableByClients','1']])->get() as $orOne )
    ...
    <!-- Takeaway 31 Menu -->
    <div class="modal fade" id="res31TaMenuModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach (Takeaway::where([['toRes','31'],['accessableByClients','1']])->get() as $orOne )
                        <div class="prodListingMenu d-flex mb-1">
                            <div class="p-2" style="width:80%;">
                                <p class="blackText" style="font-size: 1.3rem; margin-bottom:0px;">{{$orOne->emri}}</p>
                                <p class="blackText" style="font-size: 0.8rem;">{{$orOne->pershkrimi}}</p>
    ...
    <!-- Takeaway 32 Menu -->
    <div class="modal fade" id="res32TaMenuModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach (Takeaway::where([['toRes','32'],['accessableByClients','1']])->get() as $orOne )
                        <div class="prodListingMenu d-flex mb-1">
                            <div class="p-2" style="width:80%;">
                                <p class="blackText" style="font-size: 1.3rem; margin-bottom:0px;">{{$orOne->emri}}</p>
                                <p class="blackText" style="font-size: 0.8rem;">{{$orOne->pershkrimi}}</p>
    ...
    <!-- Takeaway 33 Menu -->
    <div class="modal fade" id="res33TaMenuModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach (Takeaway::where([['toRes','33'],['accessableByClients','1']])->get() as $orOne )
                        <div class="prodListingMenu d-flex mb-1">
                            <div class="p-2" style="width:80%;">
                                <p class="blackText" style="font-size: 1.3rem; margin-bottom:0px;">{{$orOne->emri}}</p>
                                <p class="blackText" style="font-size: 0.8rem;">{{$orOne->pershkrimi}}</p>
