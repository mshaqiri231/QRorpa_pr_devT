...
var progress_size = '0';
var current_slide = 1;
var per_slide_duration =  3000;
var end_duration = 800;
...
if(type == 'hide'){
    ...
    setTimeout( function() {element.removeClass('animate ').hide()});
...
var total_duration = ((total_layers*1.1)*per_slide_duration)+end_duration; 
...
function doSetTimeout(i,total_layers) {
  ...
  setTimeout( function() {  check_layer(this_slide.find(".sim-slider-layer:eq("+(i)+")"),'hide'); }, (total_layers*1200)+(i*per_slide_duration) + 1000);    
}
