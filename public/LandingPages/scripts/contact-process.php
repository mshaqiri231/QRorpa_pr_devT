...
if (isset($_POST['Email'])) {
    ...
    $email_subject = "Neue Nachricht von ".$_SERVER['HTTP_REFERER'];
    ...
    if (
        ...
        !isset($_POST['Tel'])||
        !isset($_POST['Message'])||
        !isset($_POST['tableQty'])||
        !isset($_POST['workersQty'])
    ) {
    ...
    $tableQty = $_POST['tableQty']; // required
    $workersQty = $_POST['workersQty']; // required
    ...
    $email_message = "Neue Nachricht von ".$_SERVER['HTTP_REFERER']."\n\n";
    ...
    $email_message .= "Tiche: " . clean_string($tableQty) . "\n";
    $email_message .= "Mitarbeiter: " . clean_string($workersQty) . "\n";

    if (isset($_POST["Services"])) {
    // empty() is not needed since 'checkbox' won't be sent
    // if none was selected.

        $value = implode(', ', $_POST['Services']);
        $email_message .= "Deinstleistungen: " . $value . "\n";
